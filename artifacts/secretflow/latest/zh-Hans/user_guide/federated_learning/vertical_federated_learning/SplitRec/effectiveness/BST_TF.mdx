...
<Notebook.Cell>
  ...
  <Notebook.CodeArea prompt="" stderr={false} type="output">
    <pre>
      {"{'train_loss': [0.64546186], 'train_auc_1': [0.65265113], 'train_precision_1': [0.6372045], 'train_recall_1': [0.82476777], 'val_loss': [0.61440396], 'val_auc_1': [0.7066779], 'val_precision_1': [0.6685109], 'val_recall_1': [0.8256919]}\n"}
    </pre>
  </Notebook.CodeArea>
</Notebook.Cell>
