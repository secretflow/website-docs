...
在本教程中，我们将学习如何使用 <cite>SecretFlow</cite> 来训练水平联邦的树模型。Secretflow 为水平场景提供了 <code>tree modeling</code> 能力（<code>SFXgboost</code>），<code>SFXgboost</code> 类似于 <code>XGBoost</code>，您可以轻松地将现有的 XGBoost 程序转换为 <cite>SecretFlow</cite> 的联合模型。
...
在 Secretflow 环境中创建 3 个实体 \[Alice, Bob, Charlie]， <code>Alice</code> 和 <code>Bob</code> 是客户端， <code>Charlie</code> 是服务器，那么你可以愉快地开始 <code>Federate Boosting</code> 。了。
