...
<table>
  <tbody>
    <tr>
      <td>
        [<code>FlLogisticRegressionMix</code>](#secretflow.ml.linear.fl_lr_mix.FlLogisticRegressionMix "secretflow.ml.linear.fl_lr_mix.FlLogisticRegressionMix")()
      </td>
...
<Outline domain="py" objectType="class" target={"secretflow.ml.linear.fl_lr_mix.FlLogisticRegressionMix"} module={"secretflow.ml.linear.fl_lr_mix"} fullname={"FlLogisticRegressionMix"} description={"\u57fa\u7c7b\uff1aobject"}>
  ...
  <Outline.Content>
    ...
    [<code>FlLogisticRegressionVertical</code>](#secretflow.ml.linear.FlLogisticRegressionVertical "secretflow.ml.linear.FlLogisticRegressionVertical") instances
    ...
    2. Aggregate <InlineMath>${\theta}$</InlineMath> of the <cite>FlLogisticRegressionVertical</cite> with
       [<code>SecureAggregator</code>](secretflow.security.security.aggregation.mdx#secretflow.security.aggregation.SecureAggregator "secretflow.security.aggregation.SecureAggregator").
    ...
    <table>
      <tbody>
        <tr>
          <td>
            [<code>fit</code>](#secretflow.ml.linear.fl_lr_mix.FlLogisticRegressionMix.fit "secretflow.ml.linear.fl_lr_mix.FlLogisticRegressionMix.fit")(x, y, batch\_size, epochs, aggregators, heus)
          </td>
        ...
        <tr>
          <td>
            [<code>predict</code>](#secretflow.ml.linear.fl_lr_mix.FlLogisticRegressionMix.predict "secretflow.ml.linear.fl_lr_mix.FlLogisticRegressionMix.predict")(x)
          </td>
        ...
        <FieldList>
          <dl>
            ...
            <dd className="field-body">
              - <strong>x</strong> – training vector. X should be a horizontal partitioned
                [<code>MixDataFrame</code>](secretflow.data.data.mix.mdx#secretflow.data.mix.MixDataFrame "secretflow.data.mix.MixDataFrame"), which consists
                of \:py\:class:<del id="id2">\`</del>\~secretflow\.data.vertical.VDataFrame\`s.
              - <strong>y</strong> – target vector relative to x. Y should be a horizontal partitioned
                [<code>MixDataFrame</code>](secretflow.data.data.mix.mdx#secretflow.data.mix.MixDataFrame "secretflow.data.mix.MixDataFrame") alos. X and y
              ...
              - <strong>aggregators</strong> – aggregator used to compute vertical lr. Amount of
                aggregators should be same as the <cite>VDataFrame</cite> of X.
              - <strong>heus</strong> – a list of heu used to compute vertical lr. Amount of
                heus should be same as the <cite>VDataFrame</cite> of X.
              - <strong>fxp\_bits</strong> – the fraction bit length for encoding before sending to
                heu device. Defaults to spu\_fxp\_precision(spu.spu\_pb2.FM64).
              - <strong>tol</strong> – optional, tolerance for stopping criteria. Defaults to 1e-4.
              - <strong>learning\_rate</strong> – optional, learning rate. Defaults to 0.1.
              - <strong>agg\_epochs</strong> – aggregate weights for every \{agg\_epochs} epochs.
                Defaults to 1.
              - <strong>audit\_log\_dir</strong> – a dict specifying the audit log directory for each
              ...
              - <strong>aggr\_hooks</strong> – The hooks called on each aggregation
            </dd>
          </dl>
        </FieldList>
      </Outline.Content>
      ...
      <Outline.Content>
        ...
        <FieldList>
          <dl>
            ...
            <dd className="field-body">
              <strong>x</strong> – the samples to predict.
            </dd>
...
<table>
  <tbody>
    <tr>
      <td>
        [<code>FlLrVWorker</code>](#secretflow.ml.linear.fl_lr_v.FlLrVWorker "secretflow.ml.linear.fl_lr_v.FlLrVWorker")()
      </td>
    ...
    <tr>
      <td>
        [<code>PYUFlLrVWorker</code>](#secretflow.ml.linear.fl_lr_v.PYUFlLrVWorker "secretflow.ml.linear.fl_lr_v.PYUFlLrVWorker")
      </td>

      <td>
        <code>ActorProxy(PYUFlLrVWorker)</code> 的别名
      </td>
    </tr>

    <tr>
      <td>
        [<code>FlLogisticRegressionVertical</code>](#secretflow.ml.linear.fl_lr_v.FlLogisticRegressionVertical "secretflow.ml.linear.fl_lr_v.FlLogisticRegressionVertical")(devices, ...\[, ...])
      </td>
...
<Outline domain="py" objectType="class" target={"secretflow.ml.linear.fl_lr_v.FlLrVWorker"} module={"secretflow.ml.linear.fl_lr_v"} fullname={"FlLrVWorker"} description={"\u57fa\u7c7b\uff1aobject"}>
  ...
  <Outline.Content>
    ...
    <table>
      <tbody>
        <tr>
          <td>
            [<code>init\_train\_data</code>](#secretflow.ml.linear.fl_lr_v.FlLrVWorker.init_train_data "secretflow.ml.linear.fl_lr_v.FlLrVWorker.init_train_data")(x, batch\_size, epochs\[, y, ...])
          </td>
        ...
        <tr>
          <td>
            [<code>next\_batch</code>](#secretflow.ml.linear.fl_lr_v.FlLrVWorker.next_batch "secretflow.ml.linear.fl_lr_v.FlLrVWorker.next_batch")()
          </td>
        ...
        <tr>
          <td>
            [<code>compute\_mul</code>](#secretflow.ml.linear.fl_lr_v.FlLrVWorker.compute_mul "secretflow.ml.linear.fl_lr_v.FlLrVWorker.compute_mul")(x\_batch)
          </td>
        ...
        <tr>
          <td>
            [<code>predict</code>](#secretflow.ml.linear.fl_lr_v.FlLrVWorker.predict "secretflow.ml.linear.fl_lr_v.FlLrVWorker.predict")(mul)
          </td>
        ...
        <tr>
          <td>
            [<code>compute\_loss</code>](#secretflow.ml.linear.fl_lr_v.FlLrVWorker.compute_loss "secretflow.ml.linear.fl_lr_v.FlLrVWorker.compute_loss")(y, h, avg\_flag)
          </td>
        ...
        <tr>
          <td>
            [<code>compute\_residual</code>](#secretflow.ml.linear.fl_lr_v.FlLrVWorker.compute_residual "secretflow.ml.linear.fl_lr_v.FlLrVWorker.compute_residual")(y, h)
          </td>
        ...
        <tr>
          <td>
            [<code>encode</code>](#secretflow.ml.linear.fl_lr_v.FlLrVWorker.encode "secretflow.ml.linear.fl_lr_v.FlLrVWorker.encode")(data, frac\_bits)
          </td>
        ...
        <tr>
          <td>
            [<code>decode</code>](#secretflow.ml.linear.fl_lr_v.FlLrVWorker.decode "secretflow.ml.linear.fl_lr_v.FlLrVWorker.decode")(data, frac\_bits)
          </td>
        ...
        <tr>
          <td>
            [<code>generate\_rand\_mask</code>](#secretflow.ml.linear.fl_lr_v.FlLrVWorker.generate_rand_mask "secretflow.ml.linear.fl_lr_v.FlLrVWorker.generate_rand_mask")(decode\_frac)
          </td>
        ...
        <tr>
          <td>
            [<code>get\_weight</code>](#secretflow.ml.linear.fl_lr_v.FlLrVWorker.get_weight "secretflow.ml.linear.fl_lr_v.FlLrVWorker.get_weight")()
          </td>
        ...
        <tr>
          <td>
            [<code>set\_weight</code>](#secretflow.ml.linear.fl_lr_v.FlLrVWorker.set_weight "secretflow.ml.linear.fl_lr_v.FlLrVWorker.set_weight")(w)
          </td>
        ...
        <tr>
          <td>
            [<code>update\_weight</code>](#secretflow.ml.linear.fl_lr_v.FlLrVWorker.update_weight "secretflow.ml.linear.fl_lr_v.FlLrVWorker.update_weight")(masked\_gradient, learning\_rate)
          </td>
        ...
        <tr>
          <td>
            [<code>update\_weight\_agg</code>](#secretflow.ml.linear.fl_lr_v.FlLrVWorker.update_weight_agg "secretflow.ml.linear.fl_lr_v.FlLrVWorker.update_weight_agg")(x\_batch, residual, ...)
          </td>
    ...
    <Outline domain="py" objectType="method" target={"secretflow.ml.linear.fl_lr_v.FlLrVWorker.init_train_data"} module={"secretflow.ml.linear.fl_lr_v"} fullname={"FlLrVWorker.init_train_data"} description={"Initialize the training data."} parameters={["x", "batch_size", "epochs", "y", "shuffle_seed"]}>
      <Outline.Signature fullname="FlLrVWorker.init_train_data" id="secretflow.ml.linear.fl_lr_v.FlLrVWorker.init_train_data">
        <Outline.Name>init\_train\_data</Outline.Name><Outline.ParameterList><span>(</span><Outline.Parameter><span className="name">x</span><span>:</span><span>{" "}</span><span className="name">[DataFrame](https://pandas.pydata.org/pandas-docs/dev/reference/api/pandas.DataFrame.html#pandas.DataFrame "（在 pandas v2.1.0rc0+44.g7915acbd3f）")<span>{" "}</span><span>|</span><span>{" "}</span>[ndarray](https://numpy.org/doc/stable/reference/generated/numpy.ndarray.html#numpy.ndarray "（在 NumPy v1.25）")</span></Outline.Parameter>, <Outline.Parameter><span className="name">batch\_size</span><span>:</span><span>{" "}</span><span className="name">[int](https://docs.python.org/3/library/functions.html#int "（在 Python v3.11）")</span></Outline.Parameter>, <Outline.Parameter><span className="name">epochs</span><span>:</span><span>{" "}</span><span className="name">[int](https://docs.python.org/3/library/functions.html#int "（在 Python v3.11）")</span></Outline.Parameter>, <Outline.Parameter><span className="name">y</span><span>:</span><span>{" "}</span><span className="name">[DataFrame](https://pandas.pydata.org/pandas-docs/dev/reference/api/pandas.DataFrame.html#pandas.DataFrame "（在 pandas v2.1.0rc0+44.g7915acbd3f）")<span>{" "}</span><span>|</span><span>{" "}</span>[ndarray](https://numpy.org/doc/stable/reference/generated/numpy.ndarray.html#numpy.ndarray "（在 NumPy v1.25）")<span>{" "}</span><span>|</span><span>{" "}</span>[None](https://docs.python.org/3/library/constants.html#None "（在 Python v3.11）")</span><span>{" "}</span><span>=</span><span>{" "}</span><span>None</span></Outline.Parameter>, <Outline.Parameter><span className="name">shuffle\_seed</span><span>:</span><span>{" "}</span><span className="name">[int](https://docs.python.org/3/library/functions.html#int "（在 Python v3.11）")<span>{" "}</span><span>|</span><span>{" "}</span>[None](https://docs.python.org/3/library/constants.html#None "（在 Python v3.11）")</span><span>{" "}</span><span>=</span><span>{" "}</span><span>None</span></Outline.Parameter><span>)</span></Outline.ParameterList>
      </Outline.Signature>
      ...
      <Outline.Content>
        ...
        <FieldList>
          <dl>
            ...
            <dd className="field-body">
              - <strong>x</strong> – the training vector.
              - <strong>batch\_size</strong> – number of samples per gradient update.
              - <strong>epochs</strong> – number of epochs to train the model.
              - <strong>y</strong> – optional; the target vector relative to x.
              - <strong>shuffle\_seed</strong> – optional; the data will be shuffled if not none.
            </dd>
          </dl>
        </FieldList>
      </Outline.Content>
    ...
    <Outline domain="py" objectType="method" target={"secretflow.ml.linear.fl_lr_v.FlLrVWorker.predict"} module={"secretflow.ml.linear.fl_lr_v"} fullname={"FlLrVWorker.predict"} description={"Do prediction."} parameters={["mul"]}>
      <Outline.Signature fullname="FlLrVWorker.predict" id="secretflow.ml.linear.fl_lr_v.FlLrVWorker.predict">
        <Outline.Name>predict</Outline.Name><Outline.ParameterList><span>(</span><Outline.Parameter><span className="name">mul</span><span>:</span><span>{" "}</span><span className="name">[ndarray](https://numpy.org/doc/stable/reference/generated/numpy.ndarray.html#numpy.ndarray "（在 NumPy v1.25）")</span></Outline.Parameter><span>)</span></Outline.ParameterList><Outline.ReturnType><span>{" \u2192 "}</span>[ndarray](https://numpy.org/doc/stable/reference/generated/numpy.ndarray.html#numpy.ndarray "（在 NumPy v1.25）")</Outline.ReturnType>
      </Outline.Signature>
      ...
      <Outline.Content>
        ...
        <FieldList>
          <dl>
            ...
            <dd className="field-body">
              <strong>mul</strong> – the sum of Xi\*Wi (i>0).
            </dd>
    ...
    <Outline domain="py" objectType="method" target={"secretflow.ml.linear.fl_lr_v.FlLrVWorker.compute_loss"} module={"secretflow.ml.linear.fl_lr_v"} fullname={"FlLrVWorker.compute_loss"} description={"\u57fa\u7c7b\uff1aobject"} parameters={["y", "h", "avg_flag"]}>
    ...
    <Outline domain="py" objectType="method" target={"secretflow.ml.linear.fl_lr_v.FlLrVWorker.compute_residual"} module={"secretflow.ml.linear.fl_lr_v"} fullname={"FlLrVWorker.compute_residual"} description={"\u57fa\u7c7b\uff1aobject"} parameters={["y", "h"]}>
    ...
    <Outline domain="py" objectType="method" target={"secretflow.ml.linear.fl_lr_v.FlLrVWorker.encode"} module={"secretflow.ml.linear.fl_lr_v"} fullname={"FlLrVWorker.encode"} description={"\u57fa\u7c7b\uff1aobject"} parameters={["data", "frac_bits"]}>
    ...
    <Outline domain="py" objectType="method" target={"secretflow.ml.linear.fl_lr_v.FlLrVWorker.decode"} module={"secretflow.ml.linear.fl_lr_v"} fullname={"FlLrVWorker.decode"} description={"\u57fa\u7c7b\uff1aobject"} parameters={["data", "frac_bits"]}>
    ...
    <Outline domain="py" objectType="method" target={"secretflow.ml.linear.fl_lr_v.FlLrVWorker.generate_rand_mask"} module={"secretflow.ml.linear.fl_lr_v"} fullname={"FlLrVWorker.generate_rand_mask"} description={"\u57fa\u7c7b\uff1aobject"} parameters={["decode_frac"]}>
    ...
    <Outline domain="py" objectType="method" target={"secretflow.ml.linear.fl_lr_v.FlLrVWorker.get_weight"} module={"secretflow.ml.linear.fl_lr_v"} fullname={"FlLrVWorker.get_weight"} description={"\u57fa\u7c7b\uff1aobject"} parameters={[]}>
      <Outline.Signature fullname="FlLrVWorker.get_weight" id="secretflow.ml.linear.fl_lr_v.FlLrVWorker.get_weight">
        <Outline.Name>get\_weight</Outline.Name><Outline.ParameterList><span>(</span><span>)</span></Outline.ParameterList><Outline.ReturnType><span>{" \u2192 "}</span>[ndarray](https://numpy.org/doc/stable/reference/generated/numpy.ndarray.html#numpy.ndarray "（在 NumPy v1.25）")</Outline.ReturnType>
      </Outline.Signature>

      <Outline.Content />
    </Outline>

    <Outline domain="py" objectType="method" target={"secretflow.ml.linear.fl_lr_v.FlLrVWorker.set_weight"} module={"secretflow.ml.linear.fl_lr_v"} fullname={"FlLrVWorker.set_weight"} description={"\u57fa\u7c7b\uff1aobject"} parameters={["w"]}>
      <Outline.Signature fullname="FlLrVWorker.set_weight" id="secretflow.ml.linear.fl_lr_v.FlLrVWorker.set_weight">
        <Outline.Name>set\_weight</Outline.Name><Outline.ParameterList><span>(</span><Outline.Parameter><span className="name">w</span><span>:</span><span>{" "}</span><span className="name">[ndarray](https://numpy.org/doc/stable/reference/generated/numpy.ndarray.html#numpy.ndarray "（在 NumPy v1.25）")</span></Outline.Parameter><span>)</span></Outline.ParameterList>
      </Outline.Signature>

      <Outline.Content />
    </Outline>

    <Outline domain="py" objectType="method" target={"secretflow.ml.linear.fl_lr_v.FlLrVWorker.update_weight"} module={"secretflow.ml.linear.fl_lr_v"} fullname={"FlLrVWorker.update_weight"} description={"\u57fa\u7c7b\uff1aobject"} parameters={["masked_gradient", "learning_rate"]}>
      <Outline.Signature fullname="FlLrVWorker.update_weight" id="secretflow.ml.linear.fl_lr_v.FlLrVWorker.update_weight">
        <Outline.Name>update\_weight</Outline.Name><Outline.ParameterList><span>(</span><Outline.Parameter><span className="name">masked\_gradient</span><span>:</span><span>{" "}</span><span className="name">[ndarray](https://numpy.org/doc/stable/reference/generated/numpy.ndarray.html#numpy.ndarray "（在 NumPy v1.25）")</span></Outline.Parameter>, <Outline.Parameter><span className="name">learning\_rate</span><span>:</span><span>{" "}</span><span className="name">[float](https://docs.python.org/3/library/functions.html#float "（在 Python v3.11）")</span></Outline.Parameter><span>)</span></Outline.ParameterList>
      </Outline.Signature>

      <Outline.Content />
    </Outline>

    <Outline domain="py" objectType="method" target={"secretflow.ml.linear.fl_lr_v.FlLrVWorker.update_weight_agg"} module={"secretflow.ml.linear.fl_lr_v"} fullname={"FlLrVWorker.update_weight_agg"} description={"\u57fa\u7c7b\uff1aobject"} parameters={["x_batch", "residual", "learning_rate"]}>
      <Outline.Signature fullname="FlLrVWorker.update_weight_agg" id="secretflow.ml.linear.fl_lr_v.FlLrVWorker.update_weight_agg">
        <Outline.Name>update\_weight\_agg</Outline.Name><Outline.ParameterList><span>(</span><Outline.Parameter><span className="name">x\_batch</span><span>:</span><span>{" "}</span><span className="name">[ndarray](https://numpy.org/doc/stable/reference/generated/numpy.ndarray.html#numpy.ndarray "（在 NumPy v1.25）")</span></Outline.Parameter>, <Outline.Parameter><span className="name">residual</span><span>:</span><span>{" "}</span><span className="name">[ndarray](https://numpy.org/doc/stable/reference/generated/numpy.ndarray.html#numpy.ndarray "（在 NumPy v1.25）")</span></Outline.Parameter>, <Outline.Parameter><span className="name">learning\_rate</span><span>:</span><span>{" "}</span><span className="name">[float](https://docs.python.org/3/library/functions.html#float "（在 Python v3.11）")</span></Outline.Parameter><span>)</span></Outline.ParameterList>
      </Outline.Signature>
...
<Outline domain="py" objectType="attribute" target={"secretflow.ml.linear.fl_lr_v.PYUFlLrVWorker"} module={"secretflow.ml.linear.fl_lr_v"} fullname={"PYUFlLrVWorker"} description={"ActorProxy(PYUFlLrVWorker) \u7684\u522b\u540d\nMethods:"}>
  ...
  <Outline.Content>
    ...
    <table>
      <tbody>
        ...
        <tr>
          <td>
            <code>compute\_loss</code>(y, h, avg\_flag)
          </td>
        ...
        <tr>
          <td>
            <code>compute\_mul</code>(x\_batch)
          </td>
        ...
        <tr>
          <td>
            <code>compute\_residual</code>(y, h)
          </td>
        ...
        <tr>
          <td>
            <code>decode</code>(data, frac\_bits)
          </td>
        ...
        <tr>
          <td>
            <code>encode</code>(data, frac\_bits)
          </td>
        ...
        <tr>
          <td>
            <code>generate\_rand\_mask</code>(decode\_frac)
          </td>
        ...
        <tr>
          <td>
            <code>init\_train\_data</code>(x, batch\_size, epochs\[, y, ...])
          </td>
        ...
        <tr>
          <td>
            <code>update\_weight</code>(masked\_gradient, learning\_rate)
          </td>
        ...
        <tr>
          <td>
            <code>update\_weight\_agg</code>(x\_batch, residual, ...)
          </td>
...
<Outline domain="py" objectType="class" target={"secretflow.ml.linear.fl_lr_v.FlLogisticRegressionVertical"} module={"secretflow.ml.linear.fl_lr_v"} fullname={"FlLogisticRegressionVertical"} parameters={["devices", "aggregator", "heu", "fxp_bits", "audit_log_dir"]} description={"\u57fa\u7c7b\uff1aobject"}>
  ...
  <Outline.Content>
    ...
    <table>
      <tbody>
        <tr>
          <td>
            [<code>\_\_init\_\_</code>](#secretflow.ml.linear.fl_lr_v.FlLogisticRegressionVertical.__init__ "secretflow.ml.linear.fl_lr_v.FlLogisticRegressionVertical.__init__")(devices, aggregator, heu\[, ...])
          </td>
        ...
        <tr>
          <td>
            [<code>init\_train\_data</code>](#secretflow.ml.linear.fl_lr_v.FlLogisticRegressionVertical.init_train_data "secretflow.ml.linear.fl_lr_v.FlLogisticRegressionVertical.init_train_data")(x, y, epochs, batch\_size\[, ...])
          </td>
        ...
        <tr>
          <td>
            [<code>predict</code>](#secretflow.ml.linear.fl_lr_v.FlLogisticRegressionVertical.predict "secretflow.ml.linear.fl_lr_v.FlLogisticRegressionVertical.predict")(x)
          </td>
        ...
        <tr>
          <td>
            [<code>compute\_loss</code>](#secretflow.ml.linear.fl_lr_v.FlLogisticRegressionVertical.compute_loss "secretflow.ml.linear.fl_lr_v.FlLogisticRegressionVertical.compute_loss")(x, y\[, avg\_flag])
          </td>
        ...
        <tr>
          <td>
            [<code>get\_weight</code>](#secretflow.ml.linear.fl_lr_v.FlLogisticRegressionVertical.get_weight "secretflow.ml.linear.fl_lr_v.FlLogisticRegressionVertical.get_weight")()
          </td>
        ...
        <tr>
          <td>
            [<code>set\_weight</code>](#secretflow.ml.linear.fl_lr_v.FlLogisticRegressionVertical.set_weight "secretflow.ml.linear.fl_lr_v.FlLogisticRegressionVertical.set_weight")(weight)
          </td>
        ...
        <tr>
          <td>
            [<code>fit</code>](#secretflow.ml.linear.fl_lr_v.FlLogisticRegressionVertical.fit "secretflow.ml.linear.fl_lr_v.FlLogisticRegressionVertical.fit")(x, y, batch\_size, epochs\[, tol, ...])
          </td>
        ...
        <tr>
          <td>
            [<code>fit\_in\_steps</code>](#secretflow.ml.linear.fl_lr_v.FlLogisticRegressionVertical.fit_in_steps "secretflow.ml.linear.fl_lr_v.FlLogisticRegressionVertical.fit_in_steps")(n\_step, learning\_rate, epoch)
          </td>
      ...
      <Outline.Content>
        ...
        <FieldList>
          <dl>
            ...
            <dd className="field-body">
              - <strong>devices</strong> – a list of PYU devices taking part in the computation.
              - <strong>aggregator</strong> – the aggregator instance.
              - <strong>heu</strong> – the heu device instance.
              - <strong>fxp\_bits</strong> – the fraction bit length for encoding before send to
                heu device. Defaults to spu\_fxp\_precision(spu.spu\_pb2.FM64).
              - <strong>audit\_log\_dir</strong> – a dict specifying the audit log directory for each
                device. No audit log if is None. Default to None.
                Please leave it None unless you are very sure what the audit
    ...
    <Outline domain="py" objectType="method" target={"secretflow.ml.linear.fl_lr_v.FlLogisticRegressionVertical.init_train_data"} module={"secretflow.ml.linear.fl_lr_v"} fullname={"FlLogisticRegressionVertical.init_train_data"} parameters={["x", "y", "epochs", "batch_size", "shuffle_seed"]} description={"\u57fa\u7c7b\uff1aobject"}>
    ...
    <Outline domain="py" objectType="method" target={"secretflow.ml.linear.fl_lr_v.FlLogisticRegressionVertical.compute_loss"} module={"secretflow.ml.linear.fl_lr_v"} fullname={"FlLogisticRegressionVertical.compute_loss"} parameters={["x", "y", "avg_flag"]} description={"Compute the loss."}>
      <Outline.Signature fullname="FlLogisticRegressionVertical.compute_loss" id="secretflow.ml.linear.fl_lr_v.FlLogisticRegressionVertical.compute_loss">
        <Outline.Name>compute\_loss</Outline.Name><Outline.ParameterList><span>(</span><Outline.Parameter><span className="name">x</span><span>:</span><span>{" "}</span><span className="name">[FedNdarray](secretflow.data.mdx#secretflow.data.ndarray.FedNdarray "secretflow.data.ndarray.FedNdarray")</span></Outline.Parameter>, <Outline.Parameter><span className="name">y</span><span>:</span><span>{" "}</span><span className="name">[FedNdarray](secretflow.data.mdx#secretflow.data.ndarray.FedNdarray "secretflow.data.ndarray.FedNdarray")</span></Outline.Parameter>, <Outline.Parameter><span className="name">avg\_flag</span><span>:</span><span>{" "}</span><span className="name">[bool](https://docs.python.org/3/library/functions.html#bool "（在 Python v3.11）")<span>{" "}</span><span>|</span><span>{" "}</span>[None](https://docs.python.org/3/library/constants.html#None "（在 Python v3.11）")</span><span>{" "}</span><span>=</span><span>{" "}</span><span>True</span></Outline.Parameter><span>)</span></Outline.ParameterList><Outline.ReturnType><span>{" \u2192 "}</span>[PYUObject](secretflow.device.device.device.mdx#secretflow.device.device.pyu.PYUObject "secretflow.device.device.pyu.PYUObject")</Outline.ReturnType>
      </Outline.Signature>
      ...
      <Outline.Content>
        ...
        <FieldList>
          <dl>
            ...
            <dd className="field-body">
              - <strong>x</strong> – the samples.
              - <strong>y</strong> – the label.
              - <strong>avg\_flag</strong> – whether dividing the sample number. Defaults to True.
            </dd>
      ...
      <Outline.Content>
        ...
        <FieldList>
          <dl>
            ...
            <dd className="field-body">
              <strong>weight</strong> – a dict of pyu and its weight.
            </dd>
          </dl>
        </FieldList>
      </Outline.Content>
      ...
      <Outline.Content>
        ...
        <FieldList>
          <dl>
            ...
            <dd className="field-body">
              - <strong>x</strong> – training vector.
              - <strong>y</strong> – target vector relative to x.
              - <strong>batch\_size</strong> – number of samples per gradient update.
              - <strong>epochs</strong> – number of epochs to train the model.
              - <strong>tol</strong> – optional, tolerance for stopping criteria. Defaults to 1e-4.
              - <strong>learning\_rate</strong> – optional, learning rate. Defaults to 0.1.
      ...
      <Outline.Content>
        ...
        <FieldList>
          <dl>
            ...
            <dd className="field-body">
              - <strong>n\_step</strong> – the number of steps.
              - <strong>learning\_rate</strong> – learning rate.
              - <strong>epoch</strong> – the current epoch.
            </dd>
          </dl>
        </FieldList>
      </Outline.Content>
...
<table>
  <tbody>
    <tr>
      <td>
        [<code>RegType</code>](#secretflow.ml.linear.linear_model.RegType "secretflow.ml.linear.linear_model.RegType")(value)
      </td>
    ...
    <tr>
      <td>
        [<code>LinearModel</code>](#secretflow.ml.linear.linear_model.LinearModel "secretflow.ml.linear.linear_model.LinearModel")(weights, reg\_type, sig\_type)
      </td>
...
<Outline domain="py" objectType="class" target={"secretflow.ml.linear.linear_model.RegType"} module={"secretflow.ml.linear.linear_model"} fullname={"RegType"} parameters={["value"]} description={"\u57fa\u7c7b\uff1aEnum"}>
  ...
  <Outline.Content>
    ...
    <table>
      <tbody>
        <tr>
          <td>
            [<code>Linear</code>](#secretflow.ml.linear.linear_model.RegType.Linear "secretflow.ml.linear.linear_model.RegType.Linear")
          </td>
        ...
        <tr>
          <td>
            [<code>Logistic</code>](#secretflow.ml.linear.linear_model.RegType.Logistic "secretflow.ml.linear.linear_model.RegType.Logistic")
          </td>
    ...
    <Outline domain="py" objectType="attribute" target={"secretflow.ml.linear.linear_model.RegType.Linear"} module={"secretflow.ml.linear.linear_model"} fullname={"RegType.Linear"} parameters={["value"]} description={"\u57fa\u7c7b\uff1aEnum"}>
    ...
    <Outline domain="py" objectType="attribute" target={"secretflow.ml.linear.linear_model.RegType.Logistic"} module={"secretflow.ml.linear.linear_model"} fullname={"RegType.Logistic"} parameters={["value"]} description={"\u57fa\u7c7b\uff1aEnum"}>
...
<Outline domain="py" objectType="class" target={"secretflow.ml.linear.linear_model.LinearModel"} module={"secretflow.ml.linear.linear_model"} fullname={"LinearModel"} parameters={["weights", "reg_type", "sig_type"]} description={"\u57fa\u7c7b\uff1aobject"}>
  ...
  <Outline.Content>
    ...
    <table>
      <tbody>
        <tr>
          <td>
            [<code>weights</code>](#id0 "secretflow.ml.linear.linear_model.LinearModel.weights")
          </td>
        ...
        <tr>
          <td>
            [<code>reg\_type</code>](#id5 "secretflow.ml.linear.linear_model.LinearModel.reg_type")
          </td>
        ...
        <tr>
          <td>
            [<code>sig\_type</code>](#id6 "secretflow.ml.linear.linear_model.LinearModel.sig_type")
          </td>
    ...
    <table>
      <tbody>
        <tr>
          <td>
            [<code>\_\_init\_\_</code>](#secretflow.ml.linear.linear_model.LinearModel.__init__ "secretflow.ml.linear.linear_model.LinearModel.__init__")(weights, reg\_type, sig\_type)
          </td>
    ...
    <Outline domain="py" objectType="attribute" target={"id0"} module={"secretflow.ml.linear.linear_model"} fullname={"LinearModel.weights"} parameters={["weights", "reg_type", "sig_type"]} description={"\u57fa\u7c7b\uff1aobject"}>
    ...
    <Outline domain="py" objectType="attribute" target={"id5"} module={"secretflow.ml.linear.linear_model"} fullname={"LinearModel.reg_type"} parameters={["weights", "reg_type", "sig_type"]} description={"\u57fa\u7c7b\uff1aobject"}>
    ...
    <Outline domain="py" objectType="attribute" target={"id6"} module={"secretflow.ml.linear.linear_model"} fullname={"LinearModel.sig_type"} parameters={["weights", "reg_type", "sig_type"]} description={"\u57fa\u7c7b\uff1aobject"}>
    ...
    <Outline domain="py" objectType="method" target={"secretflow.ml.linear.linear_model.LinearModel.__init__"} module={"secretflow.ml.linear.linear_model"} fullname={"LinearModel.__init__"} parameters={["weights", "reg_type", "sig_type"]} description={"\u57fa\u7c7b\uff1aobject"}>
...
<table>
  <tbody>
    <tr>
      <td>
        [<code>FlLogisticRegressionMix</code>](#secretflow.ml.linear.FlLogisticRegressionMix "secretflow.ml.linear.FlLogisticRegressionMix")()
      </td>
    ...
    <tr>
      <td>
        [<code>FlLogisticRegressionVertical</code>](#secretflow.ml.linear.FlLogisticRegressionVertical "secretflow.ml.linear.FlLogisticRegressionVertical")(devices, ...\[, ...])
      </td>
    ...
    <tr>
      <td>
        [<code>HESSLogisticRegression</code>](#secretflow.ml.linear.HESSLogisticRegression "secretflow.ml.linear.HESSLogisticRegression")(spu, heu\_x, heu\_y)
      </td>
    ...
    <tr>
      <td>
        [<code>SSRegression</code>](#secretflow.ml.linear.SSRegression "secretflow.ml.linear.SSRegression")(spu)
      </td>
    ...
    <tr>
      <td>
        [<code>LinearModel</code>](#secretflow.ml.linear.LinearModel "secretflow.ml.linear.LinearModel")(weights, reg\_type, sig\_type)
      </td>
    ...
    <tr>
      <td>
        [<code>RegType</code>](#secretflow.ml.linear.RegType "secretflow.ml.linear.RegType")(value)
      </td>
    ...
    <tr>
      <td>
        [<code>SSGLM</code>](#secretflow.ml.linear.SSGLM "secretflow.ml.linear.SSGLM")(spu)
      </td>
...
<Outline domain="py" objectType="class" target={"secretflow.ml.linear.FlLogisticRegressionMix"} module={"secretflow.ml.linear"} fullname={"FlLogisticRegressionMix"} description={"\u57fa\u7c7b\uff1aobject"}>
  ...
  <Outline.Content>
    ...
    <table>
      <tbody>
        <tr>
          <td>
            [<code>fit</code>](#secretflow.ml.linear.FlLogisticRegressionMix.fit "secretflow.ml.linear.FlLogisticRegressionMix.fit")(x, y, batch\_size, epochs, aggregators, heus)
          </td>
        ...
        <tr>
          <td>
            [<code>predict</code>](#secretflow.ml.linear.FlLogisticRegressionMix.predict "secretflow.ml.linear.FlLogisticRegressionMix.predict")(x)
          </td>
...
<Outline domain="py" objectType="class" target={"secretflow.ml.linear.FlLogisticRegressionVertical"} module={"secretflow.ml.linear"} fullname={"FlLogisticRegressionVertical"} parameters={["devices", "aggregator", "heu", "fxp_bits", "audit_log_dir"]} description={"\u57fa\u7c7b\uff1aobject"}>
  ...
  <Outline.Content>
    ...
    <table>
      <tbody>
        <tr>
          <td>
            [<code>\_\_init\_\_</code>](#secretflow.ml.linear.FlLogisticRegressionVertical.__init__ "secretflow.ml.linear.FlLogisticRegressionVertical.__init__")(devices, aggregator, heu\[, ...])
          </td>
        ...
        <tr>
          <td>
            [<code>init\_train\_data</code>](#secretflow.ml.linear.FlLogisticRegressionVertical.init_train_data "secretflow.ml.linear.FlLogisticRegressionVertical.init_train_data")(x, y, epochs, batch\_size\[, ...])
          </td>
        ...
        <tr>
          <td>
            [<code>predict</code>](#secretflow.ml.linear.FlLogisticRegressionVertical.predict "secretflow.ml.linear.FlLogisticRegressionVertical.predict")(x)
          </td>
        ...
        <tr>
          <td>
            [<code>compute\_loss</code>](#secretflow.ml.linear.FlLogisticRegressionVertical.compute_loss "secretflow.ml.linear.FlLogisticRegressionVertical.compute_loss")(x, y\[, avg\_flag])
          </td>
        ...
        <tr>
          <td>
            [<code>get\_weight</code>](#secretflow.ml.linear.FlLogisticRegressionVertical.get_weight "secretflow.ml.linear.FlLogisticRegressionVertical.get_weight")()
          </td>
        ...
        <tr>
          <td>
            [<code>set\_weight</code>](#secretflow.ml.linear.FlLogisticRegressionVertical.set_weight "secretflow.ml.linear.FlLogisticRegressionVertical.set_weight")(weight)
          </td>
        ...
        <tr>
          <td>
            [<code>fit</code>](#secretflow.ml.linear.FlLogisticRegressionVertical.fit "secretflow.ml.linear.FlLogisticRegressionVertical.fit")(x, y, batch\_size, epochs\[, tol, ...])
          </td>
        ...
        <tr>
          <td>
            [<code>fit\_in\_steps</code>](#secretflow.ml.linear.FlLogisticRegressionVertical.fit_in_steps "secretflow.ml.linear.FlLogisticRegressionVertical.fit_in_steps")(n\_step, learning\_rate, epoch)
          </td>
    ...
    <Outline domain="py" objectType="method" target={"secretflow.ml.linear.FlLogisticRegressionVertical.init_train_data"} module={"secretflow.ml.linear"} fullname={"FlLogisticRegressionVertical.init_train_data"} parameters={["x", "y", "epochs", "batch_size", "shuffle_seed"]} description={"\u57fa\u7c7b\uff1aobject"}>
...
<Outline domain="py" objectType="class" target={"secretflow.ml.linear.HESSLogisticRegression"} module={"secretflow.ml.linear"} fullname={"HESSLogisticRegression"} parameters={["spu", "heu_x", "heu_y"]} description={"\u57fa\u7c7b\uff1aobject"}>
  ...
  <Outline.Content>
    ...
    <FieldList>
      <dl>
        ...
        <dd className="field-body">
          - <strong>spu</strong> – SPU
            SPU device.
          - <strong>heu\_x</strong> – HEU
            HEU device without label.
          - <strong>heu\_y</strong> – HEU
    ...
    <table>
      <tbody>
        <tr>
          <td>
            [<code>\_\_init\_\_</code>](#secretflow.ml.linear.HESSLogisticRegression.__init__ "secretflow.ml.linear.HESSLogisticRegression.__init__")(spu, heu\_x, heu\_y)
          </td>
        ...
        <tr>
          <td>
            [<code>fit</code>](#secretflow.ml.linear.HESSLogisticRegression.fit "secretflow.ml.linear.HESSLogisticRegression.fit")(x, y\[, learning\_rate, epochs, batch\_size])
          </td>
        ...
        <tr>
          <td>
            [<code>save\_model</code>](#secretflow.ml.linear.HESSLogisticRegression.save_model "secretflow.ml.linear.HESSLogisticRegression.save_model")()
          </td>
        ...
        <tr>
          <td>
            [<code>load\_model</code>](#secretflow.ml.linear.HESSLogisticRegression.load_model "secretflow.ml.linear.HESSLogisticRegression.load_model")(m)
          </td>
        ...
        <tr>
          <td>
            [<code>predict</code>](#secretflow.ml.linear.HESSLogisticRegression.predict "secretflow.ml.linear.HESSLogisticRegression.predict")(x)
          </td>
    ...
    <Outline domain="py" objectType="method" target={"secretflow.ml.linear.HESSLogisticRegression.__init__"} module={"secretflow.ml.linear"} fullname={"HESSLogisticRegression.__init__"} parameters={["spu", "heu_x", "heu_y"]} description={"\u57fa\u7c7b\uff1aobject"}>
      ...
      <Outline.Content>
        ...
        <FieldList>
          <dl>
            ...
            <dd className="field-body">
              - <strong>x</strong> – \{FedNdarray, VDataFrame}
                Input data, must be colocated with SPU.
              - <strong>y</strong> – \{FedNdarray, VDataFrame}
                Target data, must be located on <cite>self.\_heu\_y</cite>.
              - <strong>learning\_rate</strong> – float, default=1e-3.
                Learning rate.
              - <strong>epochs</strong> – int, default=1
                Number of epochs to train the model
              - <strong>batch\_size</strong> – int, default=None
...
<Outline domain="py" objectType="class" target={"secretflow.ml.linear.SSRegression"} module={"secretflow.ml.linear"} fullname={"SSRegression"} parameters={["spu"]} description={"\u57fa\u7c7b\uff1aobject"}>
  ...
  <Outline.Content>
    ...
    <FieldList>
      <dl>
        ...
        <dd className="field-body">
          <strong>spu</strong> – secure device.
        </dd>
      </dl>
    </FieldList>
    ...
    <table>
      <tbody>
        <tr>
          <td>
            [<code>\_\_init\_\_</code>](#secretflow.ml.linear.SSRegression.__init__ "secretflow.ml.linear.SSRegression.__init__")(spu)
          </td>
        ...
        <tr>
          <td>
            [<code>fit</code>](#secretflow.ml.linear.SSRegression.fit "secretflow.ml.linear.SSRegression.fit")(x, y, epochs\[, learning\_rate, ...])
          </td>
        ...
        <tr>
          <td>
            [<code>save\_model</code>](#secretflow.ml.linear.SSRegression.save_model "secretflow.ml.linear.SSRegression.save_model")()
          </td>
        ...
        <tr>
          <td>
            [<code>load\_model</code>](#secretflow.ml.linear.SSRegression.load_model "secretflow.ml.linear.SSRegression.load_model")(m)
          </td>
        ...
        <tr>
          <td>
            [<code>predict</code>](#secretflow.ml.linear.SSRegression.predict "secretflow.ml.linear.SSRegression.predict")(x\[, batch\_size, to\_pyu])
          </td>
    ...
    <Outline domain="py" objectType="method" target={"secretflow.ml.linear.SSRegression.__init__"} module={"secretflow.ml.linear"} fullname={"SSRegression.__init__"} parameters={["spu"]} description={"\u57fa\u7c7b\uff1aobject"}>
        ...
        <FieldList>
          <dl>
            ...
            <dd className="field-body">
              ...
              - <strong>sig\_type</strong> – str, default=t1
                sigmoid approximation type.
              - <strong>reg\_type</strong> – str, default=logistic
                Linear or Logistic regression.
              - <strong>penalty</strong> – str, default=None
                The penalty (aka regularization term) to be used.
              - <strong>l2\_norm</strong> – float, default=0.5
                L2 regularization term.
              - <strong>eps</strong> – float, default=1e-3
...
<Outline domain="py" objectType="class" target={"secretflow.ml.linear.LinearModel"} module={"secretflow.ml.linear"} fullname={"LinearModel"} parameters={["weights", "reg_type", "sig_type"]} description={"\u57fa\u7c7b\uff1aobject"}>
  ...
  <Outline.Content>
    ...
    <table>
      <tbody>
        <tr>
          <td>
            [<code>weights</code>](#id11 "secretflow.ml.linear.LinearModel.weights")
          </td>
        ...
        <tr>
          <td>
            [<code>reg\_type</code>](#id12 "secretflow.ml.linear.LinearModel.reg_type")
          </td>
        ...
        <tr>
          <td>
            [<code>sig\_type</code>](#id13 "secretflow.ml.linear.LinearModel.sig_type")
          </td>
    ...
    <table>
      <tbody>
        <tr>
          <td>
            [<code>\_\_init\_\_</code>](#secretflow.ml.linear.LinearModel.__init__ "secretflow.ml.linear.LinearModel.__init__")(weights, reg\_type, sig\_type)
          </td>
    ...
    <Outline domain="py" objectType="attribute" target={"id11"} module={"secretflow.ml.linear"} fullname={"LinearModel.weights"} parameters={["weights", "reg_type", "sig_type"]} description={"\u57fa\u7c7b\uff1aobject"}>
    ...
    <Outline domain="py" objectType="attribute" target={"id12"} module={"secretflow.ml.linear"} fullname={"LinearModel.reg_type"} parameters={["weights", "reg_type", "sig_type"]} description={"\u57fa\u7c7b\uff1aobject"}>
    ...
    <Outline domain="py" objectType="attribute" target={"id13"} module={"secretflow.ml.linear"} fullname={"LinearModel.sig_type"} parameters={["weights", "reg_type", "sig_type"]} description={"\u57fa\u7c7b\uff1aobject"}>
    ...
    <Outline domain="py" objectType="method" target={"secretflow.ml.linear.LinearModel.__init__"} module={"secretflow.ml.linear"} fullname={"LinearModel.__init__"} parameters={["weights", "reg_type", "sig_type"]} description={"\u57fa\u7c7b\uff1aobject"}>
...
<Outline domain="py" objectType="class" target={"secretflow.ml.linear.RegType"} module={"secretflow.ml.linear"} fullname={"RegType"} parameters={["value"]} description={"\u57fa\u7c7b\uff1aEnum"}>
  ...
  <Outline.Content>
    ...
    <table>
      <tbody>
        <tr>
          <td>
            [<code>Linear</code>](#secretflow.ml.linear.RegType.Linear "secretflow.ml.linear.RegType.Linear")
          </td>
        ...
        <tr>
          <td>
            [<code>Logistic</code>](#secretflow.ml.linear.RegType.Logistic "secretflow.ml.linear.RegType.Logistic")
          </td>
    ...
    <Outline domain="py" objectType="attribute" target={"secretflow.ml.linear.RegType.Linear"} module={"secretflow.ml.linear"} fullname={"RegType.Linear"} parameters={["value"]} description={"\u57fa\u7c7b\uff1aEnum"}>
    ...
    <Outline domain="py" objectType="attribute" target={"secretflow.ml.linear.RegType.Logistic"} module={"secretflow.ml.linear"} fullname={"RegType.Logistic"} parameters={["value"]} description={"\u57fa\u7c7b\uff1aEnum"}>
...
<Outline domain="py" objectType="class" target={"secretflow.ml.linear.SSGLM"} module={"secretflow.ml.linear"} fullname={"SSGLM"} parameters={["spu"]} description={"\u57fa\u7c7b\uff1aobject"}>
  ...
  <Outline.Content>
    ...
    <table>
      <tbody>
        <tr>
          <td>
            [<code>\_\_init\_\_</code>](#secretflow.ml.linear.SSGLM.__init__ "secretflow.ml.linear.SSGLM.__init__")(spu)
          </td>
        ...
        <tr>
          <td>
            [<code>fit\_irls</code>](#secretflow.ml.linear.SSGLM.fit_irls "secretflow.ml.linear.SSGLM.fit_irls")(x, y, offset, weight, epochs, link, ...)
          </td>
        ...
        <tr>
          <td>
            [<code>fit\_sgd</code>](#secretflow.ml.linear.SSGLM.fit_sgd "secretflow.ml.linear.SSGLM.fit_sgd")(x, y, offset, weight, epochs, link, dist)
          </td>
        ...
        <tr>
          <td>
            [<code>predict</code>](#secretflow.ml.linear.SSGLM.predict "secretflow.ml.linear.SSGLM.predict")(x\[, o, to\_pyu])
          </td>
    ...
    <Outline domain="py" objectType="method" target={"secretflow.ml.linear.SSGLM.__init__"} module={"secretflow.ml.linear"} fullname={"SSGLM.__init__"} parameters={["spu"]} description={"\u57fa\u7c7b\uff1aobject"}>
