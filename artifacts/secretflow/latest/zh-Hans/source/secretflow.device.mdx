...
<table>
  <tbody>
    ...
    <tr>
      <td>
        [<code>parties</code>](#secretflow.device.global_state.parties "secretflow.device.global_state.parties")()
      </td>
    ...
    <tr>
      <td>
        [<code>set\_parties</code>](#secretflow.device.global_state.set_parties "secretflow.device.global_state.set_parties")(parties)
      </td>
