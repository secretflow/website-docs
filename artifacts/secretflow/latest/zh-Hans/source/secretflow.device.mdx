    ...
    <FieldList>
      <dl>
        ...
        <dd className="field-body">
          ...
          - <strong>static\_argnames</strong> (<em>Union</em><em>\[</em>[<em>str</em>](https://docs.python.org/3/library/stdtypes.html#str "（在 Python v3.11）")<em>, </em><em>Iterable</em><em>\[</em>[<em>str</em>](https://docs.python.org/3/library/stdtypes.html#str "（在 Python v3.11）")<em>]</em><em>, </em><em>None</em><em>]</em>) – See `jax.jit()` docstring.
        </dd>
      </dl>
    </FieldList>
