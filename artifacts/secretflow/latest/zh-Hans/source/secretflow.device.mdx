    ...
    <FieldList>
      <dl>
        ...
        <dd className="field-body">
          - <strong>dev</strong> ([<em>Device</em>](secretflow.device.device.device.mdx#secretflow.device.device.base.Device "secretflow.device.device.base.Device")) – Target device.
  ...
  <Outline.Content>
    ...
    <FieldList>
      <dl>
        ...
        <dd className="field-body">
          - <strong>device</strong> ([<em>Device</em>](secretflow.device.device.device.mdx#secretflow.device.device.base.Device "secretflow.device.device.base.Device")) – Target device.
        ...
        <dd className="field-body">
          [DeviceObject](secretflow.device.device.device.mdx#secretflow.device.device.base.DeviceObject "secretflow.device.device.base.DeviceObject")
        </dd>
      </dl>
    </FieldList>
  </Outline.Content>
  ...
  <Outline.Content>
    ...
    <FieldList>
      <dl>
        ...
        <dd className="field-body">
          - <strong>device\_object\_type</strong> (<em>Type</em><em>\[</em>[<em>DeviceObject</em>](secretflow.device.device.device.mdx#secretflow.device.device.base.DeviceObject "secretflow.device.device.base.DeviceObject")<em>]</em>) – DeviceObject type, eg. PYUObject.
