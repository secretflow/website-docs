...
<strong>COMP\_LIST</strong> is a CompListDef instance.
...
You must specify a component with the following format: <strong>domain/name\:version</strong>.
...
1. Save the following bash script as <em>generate\_csv.sh</em>
...
2. Save the following Python code as <em>psi\_demo.py</em>
...
4. Check result at <em>/tmp/alice/output.csv</em> and <em>/tmp/bob/output.csv</em>. The content of two files should be same except the header.
...
- result\_file: result file path.
- eval\_param: base64-encoded NodeEvalParam prototext.
...
[secretflow/component/preprocessing/train\_test\_split.py](https://github.com/secretflow/secretflow/blob/main/secretflow/component/preprocessing/train_test_split.py)

The brief steps to build a SecretFlow Component are:

1. Create a new file under <strong>secretflow/component/</strong> .
2. Create a Component class with <strong>secretflow\.component.component.Component</strong>:
...
5. Put your new component in ALL\_COMPONENTS of [secretflow.component.entry](https://github.com/secretflow/secretflow/blob/main/secretflow/component/entry.py) .
