  ...
  <Notebook.CodeArea prompt="[4]:" stderr={false} type="input">
    ...
    def data_prepare():
        ...
        train_df = pd.read_csv(
            './data_download/adult.data', delimiter=',', header=None, index_col=None, names=column_names
        )
        ...
        train_df['capital_gain'] = (train_df['capital_gain'] / 1000).astype(int).astype('string')
        train_df['capital_loss'] = (train_df['capital_loss'] / 100).astype(int).astype('string')
...
<Notebook.Cell>
  <Notebook.CodeArea prompt="[10]:" stderr={false} type="input">
    ...
    int_fea_list = ['age', 'fnlwgt', 'education_num', 'capital_gain', 'capital_loss', 'hours_per_week']
