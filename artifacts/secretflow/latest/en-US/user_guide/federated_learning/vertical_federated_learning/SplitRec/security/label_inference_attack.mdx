...
其中 loss 的计算公式如下 ![lia3](../../../../../_assets/lia3.png)

![lia4](../../../../../_assets/lia4.png):target{#Active-Label-Inference-Attack-with-the-Malicious-Local-Optimizer}
...
<Notebook.Cell>
  <Notebook.CodeArea prompt="[2]:" stderr={false} type="input">
    ...
    batch_size = 128
    train_dataset = datasets.CIFAR10(data_file_path, True, transform=transforms.ToTensor(), download=True)
...
<Notebook.Cell>
  <Notebook.CodeArea prompt="[7]:" stderr={false} type="input">
    ```python
    from secretflow.ml.nn.sl.attack.torch.label_inferece_attack import LabelInferenceAttacker
