...
SecretFlow provides [<code>SLModel</code>](../../../source/secretflow.ml.ml.nn.mdx#secretflow.ml.nn.SLModel "secretflow.ml.nn.SLModel") to define a split learning model.
