...
The SS-SGD module <code>SSRegression()</code>
...
For more detail about parameter settings, see API <code>SSRegression()</code>
...
The HESS-SGD module <code>HESSLogisticRegression()</code> implements provably
...
For more details about API, see <code>HESSLogisticRegression()</code>
