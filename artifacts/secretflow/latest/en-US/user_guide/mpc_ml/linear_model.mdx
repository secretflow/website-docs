...
The SS-SGD module `SSRegression()`
...
For more detail about parameter settings, see API `SSRegression()`
...
The HESS-SGD module `HESSLogisticRegression()` implements provably
...
For more details about API, see `HESSLogisticRegression()`
