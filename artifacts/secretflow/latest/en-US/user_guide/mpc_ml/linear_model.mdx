---
git_download_url: https://github.com/secretflow/secretflow/raw/f2c46f98224a42f29bca20751a569bbfac39f750/docs/user_guide/mpc_ml/linear_model.rst
git_last_modified_commit: b06e3ccb5bfcf23b0e982da3023a85436f82e00b
git_last_modified_time: '2023-12-25T14:23:18+08:00'
git_origin_url: https://github.com/secretflow/secretflow/blob/f2c46f98224a42f29bca20751a569bbfac39f750/docs/user_guide/mpc_ml/linear_model.rst
...
The SS-SGD module [`SSRegression()`](../../source/secretflow.ml.linear.ml.linear.ss_sgd.mdx#secretflow.ml.linear.ss_sgd.model.SSRegression "secretflow.ml.linear.ss_sgd.model.SSRegression")
...
See [Deployment](https://www.secretflow.org.cn/docs/secretflow/latest/en-US/getting_started/deployment.html) and refer to the ‘Cluster Mode’.

For more detail about parameter settings, see API [`SSRegression()`](../../source/secretflow.ml.linear.ml.linear.ss_sgd.mdx#secretflow.ml.linear.ss_sgd.model.SSRegression "secretflow.ml.linear.ss_sgd.model.SSRegression")
...
The HESS-SGD module [`HESSLogisticRegression()`](../../source/secretflow.ml.linear.ml.linear.hess_sgd.mdx#secretflow.ml.linear.hess_sgd.model.HESSLogisticRegression "secretflow.ml.linear.hess_sgd.model.HESSLogisticRegression") implements provably
...
For more details about API, see [`HESSLogisticRegression()`](../../source/secretflow.ml.linear.ml.linear.hess_sgd.mdx#secretflow.ml.linear.hess_sgd.model.HESSLogisticRegression "secretflow.ml.linear.hess_sgd.model.HESSLogisticRegression")
