...
Before reading this article, it is strongly recommended to read [TEEU Getting Started Guide](teeu.mdx) at first.
...
You can check model file at <code>/root/occlum\_instance/model.json</code> when finished.
...
Please check [Non-simulation](teeu.mdx#summary) for running in non-simulation mode.
