...
Create 3 entities in the Secretflow environment \[Alice, Bob, Charlie]. Where <code>Alice</code> and <code>Bob</code> are clients, and <code>Charlie</code> is the server,then you can happily start <code>Federate Boosting</code>.
