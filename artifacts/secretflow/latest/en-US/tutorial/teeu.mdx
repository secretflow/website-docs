...
git_download_url: https://github.com/secretflow/secretflow/raw/215ee402b76decfeb01e97c0861cab9f5ec3f823/docs/tutorial/teeu.md
git_origin_url: https://github.com/secretflow/secretflow/blob/215ee402b76decfeb01e97c0861cab9f5ec3f823/docs/tutorial/teeu.md
...
Suppose we save the code as [demo.py](http://demo.py), and then execute `python demo.py` on Alice’s machine.
...
Suppose we save the code as [demo.py](http://demo.py), and then execute `python demo.py` on Bob’s machine.
...
After the configuration is complete, suppose we save the code as [demo.py](http://demo.py), and then execute `python demo.py` on Alice’s machine.
...
After the configuration is complete, suppose we save the code as [demo.py](http://demo.py), and then execute `python demo.py` on Bob’s machine.
