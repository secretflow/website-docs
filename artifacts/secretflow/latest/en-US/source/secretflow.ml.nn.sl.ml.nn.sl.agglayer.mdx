...
<table>
  <tbody>
    <tr>
      <td>
        [<code>AggLayer</code>](#secretflow.ml.nn.sl.agglayer.agg_layer.AggLayer "secretflow.ml.nn.sl.agglayer.agg_layer.AggLayer")(device\_agg, parties, device\_y\[, ...])
      </td>
  ...
  <Outline.Content>
    ...
    <table>
      <tbody>
        <tr>
          <td>
            [<code>\_\_init\_\_</code>](#secretflow.ml.nn.sl.agglayer.agg_layer.AggLayer.__init__ "secretflow.ml.nn.sl.agglayer.agg_layer.AggLayer.__init__")(device\_agg, parties, device\_y\[, ...])
          </td>
        ...
        <tr>
          <td>
            [<code>get\_parties</code>](#secretflow.ml.nn.sl.agglayer.agg_layer.AggLayer.get_parties "secretflow.ml.nn.sl.agglayer.agg_layer.AggLayer.get_parties")()
          </td>
        ...
        <tr>
          <td>
            [<code>set\_basenet\_output\_num</code>](#secretflow.ml.nn.sl.agglayer.agg_layer.AggLayer.set_basenet_output_num "secretflow.ml.nn.sl.agglayer.agg_layer.AggLayer.set_basenet_output_num")(basenet\_output\_num)
          </td>
        ...
        <tr>
          <td>
            [<code>convert\_to\_ndarray</code>](#secretflow.ml.nn.sl.agglayer.agg_layer.AggLayer.convert_to_ndarray "secretflow.ml.nn.sl.agglayer.agg_layer.AggLayer.convert_to_ndarray")(\*data)
          </td>
        ...
        <tr>
          <td>
            [<code>convert\_to\_tensor</code>](#secretflow.ml.nn.sl.agglayer.agg_layer.AggLayer.convert_to_tensor "secretflow.ml.nn.sl.agglayer.agg_layer.AggLayer.convert_to_tensor")(hidden, backend)
          </td>
        ...
        <tr>
          <td>
            [<code>get\_hiddens</code>](#secretflow.ml.nn.sl.agglayer.agg_layer.AggLayer.get_hiddens "secretflow.ml.nn.sl.agglayer.agg_layer.AggLayer.get_hiddens")(f\_data)
          </td>
        ...
        <tr>
          <td>
            [<code>get\_reg\_loss</code>](#secretflow.ml.nn.sl.agglayer.agg_layer.AggLayer.get_reg_loss "secretflow.ml.nn.sl.agglayer.agg_layer.AggLayer.get_reg_loss")(f\_data)
          </td>
        ...
        <tr>
          <td>
            [<code>set\_forward\_data</code>](#secretflow.ml.nn.sl.agglayer.agg_layer.AggLayer.set_forward_data "secretflow.ml.nn.sl.agglayer.agg_layer.AggLayer.set_forward_data")(hidden, losses)
          </td>
        ...
        <tr>
          <td>
            [<code>decompress\_hiddens</code>](#secretflow.ml.nn.sl.agglayer.agg_layer.AggLayer.decompress_hiddens "secretflow.ml.nn.sl.agglayer.agg_layer.AggLayer.decompress_hiddens")(data, compressor)
          </td>
        ...
        <tr>
          <td>
            [<code>compress\_gradients</code>](#secretflow.ml.nn.sl.agglayer.agg_layer.AggLayer.compress_gradients "secretflow.ml.nn.sl.agglayer.agg_layer.AggLayer.compress_gradients")(gradients, ...)
          </td>
        ...
        <tr>
          <td>
            [<code>split\_to\_parties</code>](#secretflow.ml.nn.sl.agglayer.agg_layer.AggLayer.split_to_parties "secretflow.ml.nn.sl.agglayer.agg_layer.AggLayer.split_to_parties")(data)
          </td>
        ...
        <tr>
          <td>
            [<code>collect</code>](#secretflow.ml.nn.sl.agglayer.agg_layer.AggLayer.collect "secretflow.ml.nn.sl.agglayer.agg_layer.AggLayer.collect")(data)
          </td>
        ...
        <tr>
          <td>
            [<code>parse\_gradients</code>](#secretflow.ml.nn.sl.agglayer.agg_layer.AggLayer.parse_gradients "secretflow.ml.nn.sl.agglayer.agg_layer.AggLayer.parse_gradients")(gradients)
          </td>
        ...
        <tr>
          <td>
            [<code>scatter</code>](#secretflow.ml.nn.sl.agglayer.agg_layer.AggLayer.scatter "secretflow.ml.nn.sl.agglayer.agg_layer.AggLayer.scatter")(data)
          </td>
        ...
        <tr>
          <td>
            [<code>forward</code>](#secretflow.ml.nn.sl.agglayer.agg_layer.AggLayer.forward "secretflow.ml.nn.sl.agglayer.agg_layer.AggLayer.forward")(data\[, axis, weights])
          </td>
        ...
        <tr>
          <td>
            [<code>backward</code>](#secretflow.ml.nn.sl.agglayer.agg_layer.AggLayer.backward "secretflow.ml.nn.sl.agglayer.agg_layer.AggLayer.backward")(gradient\[, weights])
          </td>
        ...
        <FieldList>
          <dl>
            ...
            <dd className="field-body">
              ...
              - <Outline.ParameterTarget>axis</Outline.ParameterTarget> – Along which axis will the merge be done, default 0
              - <Outline.ParameterTarget>weights</Outline.ParameterTarget> – weight of each side, default to be none
            </dd>
        ...
        <FieldList>
          <dl>
            ...
            <dd className="field-body">
              ...
              - <Outline.ParameterTarget>weights</Outline.ParameterTarget> – Weights of each side, default to be none
            </dd>
...
<table>
  <tbody>
    <tr>
      <td>
        [<code>auto\_grad</code>](#secretflow.ml.nn.sl.agglayer.agg_method.auto_grad "secretflow.ml.nn.sl.agglayer.agg_method.auto_grad")(func)
      </td>
...
<table>
  <tbody>
    <tr>
      <td>
        [<code>AggMethod</code>](#secretflow.ml.nn.sl.agglayer.agg_method.AggMethod "secretflow.ml.nn.sl.agglayer.agg_method.AggMethod")()
      </td>
    ...
    <tr>
      <td>
        [<code>Average</code>](#secretflow.ml.nn.sl.agglayer.agg_method.Average "secretflow.ml.nn.sl.agglayer.agg_method.Average")()
      </td>
  ...
  <Outline.Content>
    ...
    <table>
      <tbody>
        <tr>
          <td>
            [<code>\_\_init\_\_</code>](#secretflow.ml.nn.sl.agglayer.agg_method.AggMethod.__init__ "secretflow.ml.nn.sl.agglayer.agg_method.AggMethod.__init__")()
          </td>
        ...
        <tr>
          <td>
            [<code>forward</code>](#secretflow.ml.nn.sl.agglayer.agg_method.AggMethod.forward "secretflow.ml.nn.sl.agglayer.agg_method.AggMethod.forward")(data, \*\*kwargs)
          </td>
        ...
        <tr>
          <td>
            [<code>backward</code>](#secretflow.ml.nn.sl.agglayer.agg_method.AggMethod.backward "secretflow.ml.nn.sl.agglayer.agg_method.AggMethod.backward")(\*gradients, parties\_num, weights, ...)
          </td>
    ...
    <Outline domain="py" objectType="method" target={"secretflow.ml.nn.sl.agglayer.agg_method.AggMethod.backward"} module={"secretflow.ml.nn.sl.agglayer.agg_method"} fullname={"AggMethod.backward"} description={"Bases: ABC"} parameters={["gradients", "parties_num", "weights", "inputs"]}>
...
<Outline domain="py" objectType="class" target={"secretflow.ml.nn.sl.agglayer.agg_method.Average"} module={"secretflow.ml.nn.sl.agglayer.agg_method"} fullname={"Average"} description={"Bases: AggMethod"}>
  ...
  <Outline.Content>
    Bases: [<code>AggMethod</code>](#secretflow.ml.nn.sl.agglayer.agg_method.AggMethod "secretflow.ml.nn.sl.agglayer.agg_method.AggMethod")
    ...
    <table>
      <tbody>
        <tr>
          <td>
            [<code>\_\_init\_\_</code>](#secretflow.ml.nn.sl.agglayer.agg_method.Average.__init__ "secretflow.ml.nn.sl.agglayer.agg_method.Average.__init__")()
          </td>
        ...
        <tr>
          <td>
            [<code>forward</code>](#secretflow.ml.nn.sl.agglayer.agg_method.Average.forward "secretflow.ml.nn.sl.agglayer.agg_method.Average.forward")(\*data\[, axis, weights])
          </td>
    ...
    <Outline domain="py" objectType="method" target={"secretflow.ml.nn.sl.agglayer.agg_method.Average.__init__"} module={"secretflow.ml.nn.sl.agglayer.agg_method"} fullname={"Average.__init__"} description={"Bases: AggMethod"} parameters={[]}>
