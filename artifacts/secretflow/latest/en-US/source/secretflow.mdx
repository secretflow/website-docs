---
git_download_url: https://github.com/secretflow/secretflow/raw/f2c46f98224a42f29bca20751a569bbfac39f750/docs/source/secretflow.rst
git_last_modified_commit: c59f45b86fd3a02c15396643ebfaab772747004d
git_last_modified_time: '2022-11-17T10:54:06+08:00'
git_origin_url: https://github.com/secretflow/secretflow/blob/f2c46f98224a42f29bca20751a569bbfac39f750/docs/source/secretflow.rst
...
<TableOfContents>
  ...
  - [secretflow.component package](secretflow.component.mdx)
    ...
    - [secretflow.component.batch\_reader module](secretflow.component.mdx#module-secretflow.component.batch_reader)
  ...
  - [secretflow.compute package](secretflow.compute.mdx)
    - [Submodules](secretflow.compute.mdx#submodules)
    - [secretflow.compute.compute module](secretflow.compute.mdx#module-secretflow.compute.compute)
    - [secretflow.compute.tracer module](secretflow.compute.mdx#module-secretflow.compute.tracer)
    - [Module contents](secretflow.compute.mdx#module-secretflow.compute)
  ...
  - [secretflow.ic package](secretflow.ic.mdx)
    - [Subpackages](secretflow.ic.mdx#subpackages)
    - [Module contents](secretflow.ic.mdx#module-secretflow.ic)
  - [secretflow.kuscia package](secretflow.kuscia.mdx)
    ...
    - [secretflow.kuscia.meta\_conversion module](secretflow.kuscia.mdx#module-secretflow.kuscia.meta_conversion)
  ...
  - [secretflow.preprocessing package](secretflow.preprocessing.mdx)
    ...
    - [secretflow.preprocessing.cond\_filter\_v module](secretflow.preprocessing.mdx#module-secretflow.preprocessing.cond_filter_v)
  ...
  - [secretflow.spec package](secretflow.spec.mdx)
    ...
    - [Module contents](secretflow.spec.mdx#module-secretflow.spec)
  - [secretflow.stats package](secretflow.stats.mdx)
    ...
    - [secretflow.stats.groupby\_v module](secretflow.stats.mdx#module-secretflow.stats.groupby_v)
  ...
  - [secretflow.tune package](secretflow.tune.mdx)
    - [Subpackages](secretflow.tune.mdx#subpackages)
    - [Submodules](secretflow.tune.mdx#submodules)
    - [secretflow.tune.result module](secretflow.tune.mdx#module-secretflow.tune.result)
    - [secretflow.tune.result\_grid module](secretflow.tune.mdx#module-secretflow.tune.result_grid)
    - [secretflow.tune.train module](secretflow.tune.mdx#module-secretflow.tune.train)
    - [secretflow.tune.tune\_config module](secretflow.tune.mdx#module-secretflow.tune.tune_config)
    - [secretflow.tune.tuner module](secretflow.tune.mdx#module-secretflow.tune.tuner)
    - [Module contents](secretflow.tune.mdx#module-secretflow.tune)
  - [secretflow.utils package](secretflow.utils.mdx)
    ...
    - [secretflow.utils.consistent\_ops module](secretflow.utils.mdx#module-secretflow.utils.consistent_ops)
...
## <Target id="secretflow-cli-module" />secretflow\.cli module
...
## <Target id="secretflow-version-module" />secretflow\.version module
...
<table>
  <tbody>
    ...
    <tr>
      <td>
        [`SPU`](#secretflow.SPU "secretflow.SPU")(cluster\_def, link\_desc, log\_options, id)
      </td>
...
<table>
  <tbody>
    ...
    <tr>
      <td>
        [`shutdown`](#secretflow.shutdown "secretflow.shutdown")(\[barrier\_on\_shutdown])
      </td>
...
<Outline domain="py" objectType="class" target={"secretflow.HEU"} module={"secretflow"} fullname={"HEU"} parameters={["config", "spu_field_type"]} description={"Bases: Device"}>
  ...
  <Outline.Content>
    Bases: [`Device`](secretflow.device.device.device.mdx#secretflow.device.device.base.Device "secretflow.device.device.base.Device")
    ...
    <Outline domain="py" objectType="method" target={"secretflow.HEU.init"} module={"secretflow"} fullname={"HEU.init"} parameters={[]} description={"Bases: Device"}>
    ...
    <Outline domain="py" objectType="method" target={"secretflow.HEU.sk_keeper_name"} module={"secretflow"} fullname={"HEU.sk_keeper_name"} parameters={[]} description={"Bases: Device"}>
    ...
    <Outline domain="py" objectType="method" target={"secretflow.HEU.evaluator_names"} module={"secretflow"} fullname={"HEU.evaluator_names"} parameters={[]} description={"Bases: Device"}>
    ...
    <Outline domain="py" objectType="method" target={"secretflow.HEU.has_party"} module={"secretflow"} fullname={"HEU.has_party"} parameters={["party"]} description={"Bases: Device"}>
...
<Outline domain="py" objectType="class" target={"secretflow.PYU"} module={"secretflow"} fullname={"PYU"} parameters={["party"]} description={"Bases: Device"}>
  ...
  <Outline.Content>
    ...
    <Outline domain="py" objectType="method" target={"secretflow.PYU.dump"} module={"secretflow"} fullname={"PYU.dump"} parameters={["obj", "path"]} description={"Bases: Device"}>
    ...
    <Outline domain="py" objectType="method" target={"secretflow.PYU.load"} module={"secretflow"} fullname={"PYU.load"} parameters={["path"]} description={"Bases: Device"}>
...
<Outline domain="py" objectType="class" target={"secretflow.SPU"} module={"secretflow"} fullname={"SPU"} parameters={["cluster_def: ~typing.Dict", "link_desc: ~typing.Dict | None = None", "log_options: ~spu.libspu.logging.LogOptions = <spu.libspu.logging.LogOptions object>", "id: str | None = None"]} description={"Bases: Device"}>
  ...
  <Outline.Content>
    ...
    <table>
      <tbody>
        ...
        <tr>
          <td>
            [`psi_v2`](#secretflow.SPU.psi_v2 "secretflow.SPU.psi_v2")(keys, input\_path, output\_path, receiver)
          </td>
    ...
    <Outline domain="py" objectType="method" target={"secretflow.SPU.__init__"} module={"secretflow"} fullname={"SPU.__init__"} parameters={["cluster_def: ~typing.Dict", "link_desc: ~typing.Dict | None = None", "log_options: ~spu.libspu.logging.LogOptions = <spu.libspu.logging.LogOptions object>", "id: str | None = None"]} description={"SPU device constructor."}>
    ...
    <Outline domain="py" objectType="method" target={"secretflow.SPU.shutdown"} module={"secretflow"} fullname={"SPU.shutdown"} parameters={[]} description={"Bases: Device"}>
    ...
    <Outline domain="py" objectType="method" target={"secretflow.SPU.dump"} module={"secretflow"} fullname={"SPU.dump"} parameters={["obj", "paths"]} description={"Bases: Device"}>
    ...
    <Outline domain="py" objectType="method" target={"secretflow.SPU.load"} module={"secretflow"} fullname={"SPU.load"} parameters={["paths"]} description={"Bases: Device"}>
    ...
    <Outline domain="py" objectType="method" target={"secretflow.SPU.infeed_shares"} module={"secretflow"} fullname={"SPU.infeed_shares"} parameters={["io_info", "shares_chunk"]} description={"Bases: Device"}>
    ...
    <Outline domain="py" objectType="method" target={"secretflow.SPU.outfeed_shares"} module={"secretflow"} fullname={"SPU.outfeed_shares"} parameters={["shares_name"]} description={"Bases: Device"}>
        ...
        <FieldList>
          <dl>
            ...
            <dd className="field-body">
              ...
              - <Outline.ParameterTarget>dfs</Outline.ParameterTarget> (<em>List</em><em>\[</em>[<em>PYUObject</em>](#secretflow.PYUObject "secretflow.PYUObject")<em>]</em>) – DataFrames to be joined, which
      ...
      <Outline.Content>
        ...
        <FieldList>
          <dl>
            ...
            <dd className="field-body">
              - <Outline.ParameterTarget>key</Outline.ParameterTarget> ([<em>str</em>](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.12)")<em>, </em><em>List</em><em>\[</em>[<em>str</em>](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.12)")<em>]</em><em>, </em><em>Dict</em><em>\[</em>[<em>Device</em>](#secretflow.Device "secretflow.Device")<em>, </em><em>List</em><em>\[</em>[<em>str</em>](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.12)")<em>]</em><em>]</em>) – Column(s) used to join.
              - <Outline.ParameterTarget>dfs</Outline.ParameterTarget> (<em>List</em><em>\[</em>[<em>PYUObject</em>](#secretflow.PYUObject "secretflow.PYUObject")<em>]</em>) – DataFrames to be joined, which should be colocated with SPU runtimes.
    ...
    <Outline domain="py" objectType="method" target={"secretflow.SPU.psi_v2"} module={"secretflow"} fullname={"SPU.psi_v2"} parameters={["keys", "input_path", "output_path", "receiver", "broadcast_result", "protocol", "ecdh_curve", "advanced_join_type", "left_side", "skip_duplicates_check", "disable_alignment", "check_hash_digest"]} description={"Private set intersection V2 API.\nPlease check https://www.secretflow.org.cn/docs/psi/latest/en-US/reference/psi_v2_config for details."}>
      <Outline.Signature fullname="SPU.psi_v2" id="secretflow.SPU.psi_v2">
...
<Outline domain="py" objectType="class" target={"secretflow.TEEU"} module={"secretflow"} fullname={"TEEU"} parameters={["party", "mr_enclave"]} description={"Bases: Device"}>
...
<Outline domain="py" objectType="class" target={"secretflow.Device"} module={"secretflow"} fullname={"Device"} parameters={["device_type"]} description={"Bases: ABC"}>
      ...
      <Outline.Content>
        ...
        <FieldList>
          <dl>
            ...
            <dd className="field-body">
              <Outline.ParameterTarget>device\_type</Outline.ParameterTarget> ([<em>DeviceType</em>](secretflow.device.device.device.mdx#secretflow.device.device.register.DeviceType "secretflow.device.device.register.DeviceType")) – underlying device type
            </dd>
          </dl>
        </FieldList>
      </Outline.Content>
...
<Outline domain="py" objectType="class" target={"secretflow.DeviceObject"} module={"secretflow"} fullname={"DeviceObject"} parameters={["device"]} description={"Bases: ABC"}>
  ...
  <Outline.Content>
    ...
    <table>
      <tbody>
        <tr>
          <td>
            [`device`](#secretflow.DeviceObject.device "secretflow.DeviceObject.device")
          </td>
      ...
      <Outline.Content>
        ...
        <FieldList>
          <dl>
            ...
            <dd className="field-body">
              <Outline.ParameterTarget>device</Outline.ParameterTarget> ([<em>Device</em>](#secretflow.Device "secretflow.Device")) – Device where this object is located.
            </dd>
          </dl>
        </FieldList>
      </Outline.Content>
    ...
    <Outline domain="py" objectType="attribute" target={"secretflow.DeviceObject.device"} module={"secretflow"} fullname={"DeviceObject.device"} parameters={["device"]} description={"Bases: ABC"}>
      <Outline.Signature fullname="DeviceObject.device" id="secretflow.DeviceObject.device">
        <Outline.Name>device</Outline.Name><Outline.Keyword><span>:</span><span>{" "}</span>[Device](secretflow.device.device.device.mdx#secretflow.device.device.base.Device "secretflow.device.device.base.Device")</Outline.Keyword>
      </Outline.Signature>
      ...
      <Outline.Content>
        ...
        <FieldList>
          <dl>
            ...
            <dd className="field-body">
              - <Outline.ParameterTarget>device</Outline.ParameterTarget> ([<em>Device</em>](#secretflow.Device "secretflow.Device")) – Target device
...
<Outline domain="py" objectType="class" target={"secretflow.HEUObject"} module={"secretflow"} fullname={"HEUObject"} parameters={["device", "data", "location_party", "is_plain"]} description={"Bases: DeviceObject"}>
  ...
  <Outline.Content>
    Bases: [`DeviceObject`](secretflow.device.device.device.mdx#secretflow.device.device.base.DeviceObject "secretflow.device.device.base.DeviceObject")
    ...
    <table>
      <tbody>
        <tr>
          <td>
            [`device`](#secretflow.HEUObject.device "secretflow.HEUObject.device")
          </td>
      ...
      <Outline.Content>
        ...
        <FieldList>
          <dl>
            ...
            <dd className="field-body">
              - <Outline.ParameterTarget>subgroup\_map</Outline.ParameterTarget> (<em>List</em><em>\[</em><em>Union</em><em>\[</em>[<em>PYUObject</em>](#secretflow.PYUObject "secretflow.PYUObject")<em>, </em><em>np.ndarray</em><em>]</em><em>]</em>) – elements in each subset of elements of self.
              - <Outline.ParameterTarget>order\_map</Outline.ParameterTarget> (<em>Union</em><em>\[</em>[<em>PYUObject</em>](#secretflow.PYUObject "secretflow.PYUObject")<em>, </em><em>np.ndarray</em><em>]</em>) – shape (self.row\_num, feature\_num). map\[i,j] = k means element i, feature j is in bucket k.
    ...
    <Outline domain="py" objectType="attribute" target={"secretflow.HEUObject.device"} module={"secretflow"} fullname={"HEUObject.device"} parameters={["device", "data", "location_party", "is_plain"]} description={"Bases: DeviceObject"}>
      <Outline.Signature fullname="HEUObject.device" id="secretflow.HEUObject.device">
        <Outline.Name>device</Outline.Name><Outline.Keyword><span>:</span><span>{" "}</span>[Device](#secretflow.Device "secretflow.Device")</Outline.Keyword>
      </Outline.Signature>
...
<Outline domain="py" objectType="class" target={"secretflow.PYUObject"} module={"secretflow"} fullname={"PYUObject"} parameters={["device", "data"]} description={"Bases: DeviceObject"}>
  ...
  <Outline.Content>
    ...
    <table>
      <tbody>
        <tr>
          <td>
            [`device`](#secretflow.PYUObject.device "secretflow.PYUObject.device")
          </td>
    ...
    <Outline domain="py" objectType="attribute" target={"secretflow.PYUObject.device"} module={"secretflow"} fullname={"PYUObject.device"} parameters={["device", "data"]} description={"Bases: DeviceObject"}>
      <Outline.Signature fullname="PYUObject.device" id="secretflow.PYUObject.device">
...
<Outline domain="py" objectType="class" target={"secretflow.SPUObject"} module={"secretflow"} fullname={"SPUObject"} parameters={["device", "meta", "shares_name"]} description={"Bases: DeviceObject"}>
  ...
  <Outline.Content>
    ...
    <table>
      <tbody>
        <tr>
          <td>
            [`device`](#secretflow.SPUObject.device "secretflow.SPUObject.device")
          </td>
    ...
    <Outline domain="py" objectType="attribute" target={"secretflow.SPUObject.device"} module={"secretflow"} fullname={"SPUObject.device"} parameters={["device", "meta", "shares_name"]} description={"Bases: DeviceObject"}>
      <Outline.Signature fullname="SPUObject.device" id="secretflow.SPUObject.device">
        <Outline.Name>device</Outline.Name><Outline.Keyword><span>:</span><span>{" "}</span>[Device](secretflow.device.device.device.mdx#secretflow.device.device.base.Device "secretflow.device.device.base.Device")</Outline.Keyword>
      </Outline.Signature>
    ...
    <FieldList>
      <dl>
        ...
        <dd className="field-body">
          ...
          - <Outline.ParameterTarget>job\_bame</Outline.ParameterTarget> – options; the job name of the current job which takes effect in
          ...
          - <Outline.ParameterTarget>cross\_silo\_comm\_options</Outline.ParameterTarget> –&#x20;
            ...
            >
            >               <dt>
            >                 <DefinitionList.Term><span>sending\_failure\_handler</span></DefinitionList.Term>
            >               </dt>
            >
            >               <dd>
            >                 This callback will be called if cross-silo sending failed and
            >                 exit\_on\_sending\_failure is True. The input param of this callable is
            >                 the sending error.
            >               </dd>
            >
            >               <dt>
          ...
          - <Outline.ParameterTarget>debug\_mode</Outline.ParameterTarget> – Whether to enable debug mode. In debug mode, single-process simulation
...
<Outline domain="py" objectType="function" target={"secretflow.proxy"} module={"secretflow"} fullname={"proxy"} parameters={["device_object_type", "max_concurrency", "_simulation_max_concurrency", "num_gpus"]} description={"Define a device class which should accept DeviceObject as method parameters and return DeviceObject."}>
  ...
  <Outline.Content>
    ...
    <FieldList>
      <dl>
        ...
        <dd className="field-body">
          - <Outline.ParameterTarget>device\_object\_type</Outline.ParameterTarget> (<em>Type</em><em>\[</em>[<em>DeviceObject</em>](#secretflow.DeviceObject "secretflow.DeviceObject")<em>]</em>) – DeviceObject type, eg. PYUObject.
...
<Outline domain="py" objectType="function" target={"secretflow.shutdown"} module={"secretflow"} fullname={"shutdown"} parameters={["barrier_on_shutdown"]} description={"Disconnect the worker, and terminate processes started by secretflow.init()."}>
  <Outline.Signature fullname="shutdown" id="secretflow.shutdown">
    <Outline.Prefix>secretflow.</Outline.Prefix><Outline.Name>shutdown</Outline.Name><Outline.ParameterList><span>(</span><Outline.Parameter><span className="name">barrier\_on\_shutdown</span><span>=</span><span>True</span></Outline.Parameter><span>)</span></Outline.ParameterList>
  </Outline.Signature>
  ...
  <Outline.Content>
    ...
    >             <dl>
    >               <dt>
    >                 <DefinitionList.Term><span>barrier\_on\_shutdown: whether barrier on shutdown. It’s useful in some cases</span></DefinitionList.Term>
    >               </dt>
    >
    >               <dd>
