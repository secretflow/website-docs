...
<Outline domain="py" objectType="class" target={"secretflow.ml.nn.fl.backend.torch.fl_base.BaseTorchModel"} module={"secretflow.ml.nn.fl.backend.torch.fl_base"} fullname={"BaseTorchModel"} parameters={["builder_base", "random_seed"]} description={"Bases: ABC"}>
  ...
  <Outline.Content>
    ...
    <Outline domain="py" objectType="method" target={"secretflow.ml.nn.fl.backend.torch.fl_base.BaseTorchModel.__init__"} module={"secretflow.ml.nn.fl.backend.torch.fl_base"} fullname={"BaseTorchModel.__init__"} parameters={["builder_base", "random_seed"]} description={"Bases: ABC"}>
