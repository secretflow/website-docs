...
git_download_url: https://github.com/secretflow/secretflow/raw/215ee402b76decfeb01e97c0861cab9f5ec3f823/docs/developer/benchmark/psi_benchmark.md
git_origin_url: https://github.com/secretflow/secretflow/blob/215ee402b76decfeb01e97c0861cab9f5ec3f823/docs/developer/benchmark/psi_benchmark.md
git_owner: secretflow
git_repo: secretflow
git_timestamp: '2023-12-06T20:08:22+08:00'
---

:target{#psi-benchmark}
...
![](../../_assets/4bded9b0-d913-48b2-b7a9-c05e0d2c7c81.png)
...
如下图所示就代表环境搭建成功了
![](../../_assets/9bab546b-6578-4ff7-b8f7-9f26ab4df46a.png)
...
如下图就代表节点创建成功了
![](../../_assets/3386cb76-53c1-4df6-ae5e-a26314609d5c.png)
同时我们也可以通过ray status去看节点的状态，前提是先进入sf环境（conda activate sf-benchmark）
![](../../_assets/e63ba232-025b-4b4f-9c57-d61d80cc8a1f.png)

:target{#id8}

#### 生成数据

把[generate\_psi.py](https://github.com/secretflow/spu/blob/main/libspu/psi/tools/generate_psi.py)脚本传到alice机器的root目录下
执行如下代码
...
把生成的psi\_1.csv cp到benchmark目录下，再通过scp的命令把psi\_2.csv/psi\_3.csv分别移到bob的benchmark目录下跟carol的benchark目录下
...
![](../../_assets/7629c228-bc51-4ef7-93e9-9f0c465d025d.png)
