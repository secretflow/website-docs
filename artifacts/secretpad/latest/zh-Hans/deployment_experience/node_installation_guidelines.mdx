---
git_download_url: https://github.com/secretflow/secretpad/raw/d39fdf937819339721ae1c6c15cc83c3cb838c05/docs/deployment_experience/node_installation_guidelines.md
git_last_modified_commit: f0750de387773f69ae9ca5f6190d483d0351f70f
git_last_modified_time: '2023-11-30T11:44:20+08:00'
git_origin_url: https://github.com/secretflow/secretpad/blob/d39fdf937819339721ae1c6c15cc83c3cb838c05/docs/deployment_experience/node_installation_guidelines.md
...
![Node\_deployment](../_assets/node_deployment.jpeg)

:target{#id}

## 第 1 步：节点注册-获取节点ID、节点令牌

![Node\_step1](../_assets/node_step1.png)

点击节点名称获取：①节点ID、②节点部署令牌

![Node\_step2](../_assets/node_step2.png)

![Node\_step3](../_assets/node_step3.png)
...
![Node\_step4](../_assets/node_step4.png)
...
输入 cd ——把解压的安装包拖入到终端（或输入sercretpad\_pkg的路径）——再输入 sh [install.sh](http://install.sh) lite -n ①平台的节点id
\-m ‘[https://③master的IP:18080](https://xn--masterIP-er1er109e:18080)’ -t ②页面token -p 端口号(一般从30001开始）

![Node\_step5](../_assets/node_step5.png)
...
![Node\_step6](../_assets/node_step6.png)
...
![Node\_step9](../_assets/node_step9.png)
...
如：找到容器名——输入命令行：bash [install.sh](http://install.sh) lite -n gmmrgcgt -m ‘[https://lan-kuscia-master:1080](https://lan-kuscia-master:1080)’ -t
nNiJL6sKjSmVJUuyj66AK7k6rWT9DMqA -p 30002——回车即可创建节点成功。

![Node\_step10](../_assets/node_step10.png)

<em>最后更新时间：2023/9/8 14:50:19</em>
