---
git_download_url: https://github.com/secretflow/scql/raw/f8a1a30688868496fb9aa22bbd75cdcfe5793e99/docs/reference/broker-api.rst
git_last_modified_commit: df49a96e4b89e1750db42f98a3273e8489352133
git_last_modified_time: '2024-01-05T15:00:17+08:00'
git_origin_url: https://github.com/secretflow/scql/blob/f8a1a30688868496fb9aa22bbd75cdcfe5793e99/docs/reference/broker-api.rst
...
paths:
  ...
  /intra/query/submit:
    post:
      summary: Run Query asynchronously
      operationId: IntraBrokerService_SubmitQuery
      responses:
        "200":
          description: A successful response.
          schema:
            $ref: '#/definitions/pbSubmitResponse'
        default:
          description: An unexpected error response.
          schema:
            $ref: '#/definitions/googlerpcStatus'
  ...
  /intra/query/fetch:
    post:
      summary: Fetch query result of asynchronous query
      ...
      parameters:
        - name: body
          ...
          required: true
          schema:
            $ref: '#/definitions/pbFetchResultRequest'
      tags:
        - IntraBrokerService
    ...
    post:
      ...
      responses:
        "200":
          description: A successful response.
          schema:
            $ref: '#/definitions/pbCreateProjectResponse'
        default:
          description: An unexpected error response.
          schema:
            $ref: '#/definitions/googlerpcStatus'
  ...
  /intra/project/list:
    post:
      summary: List All Projects that have created and joined
      operationId: IntraBrokerService_ListProjects
      responses:
        "200":
          description: A successful response.
          schema:
            $ref: '#/definitions/pbListProjectsResponse'
        default:
          description: An unexpected error response.
          schema:
            $ref: '#/definitions/googlerpcStatus'
      parameters:
        - name: body
          ...
          required: true
          schema:
            $ref: '#/definitions/pbListProjectsRequest'
      tags:
        - IntraBrokerService
  /intra/member/invite:
    post:
      summary: Invite another member to join the Project you created
      operationId: IntraBrokerService_InviteMember
      responses:
        "200":
          description: A successful response.
          schema:
            $ref: '#/definitions/pbInviteMemberResponse'
        default:
          description: An unexpected error response.
          schema:
            $ref: '#/definitions/googlerpcStatus'
      parameters:
        - name: body
          ...
          required: true
          schema:
            $ref: '#/definitions/pbInviteMemberRequest'
      tags:
        - IntraBrokerService
  /intra/invitation/list:
    post:
      summary: List all invitations sent and received
      operationId: IntraBrokerService_ListInvitations
      responses:
        "200":
          description: A successful response.
          schema:
            $ref: '#/definitions/pbListInvitationsResponse'
        default:
          description: An unexpected error response.
          schema:
            $ref: '#/definitions/googlerpcStatus'
      parameters:
        - name: body
          ...
          required: true
          schema:
            $ref: '#/definitions/pbListInvitationsRequest'
      tags:
        - IntraBrokerService
    ...
    post:
      ...
      responses:
        "200":
          description: A successful response.
          schema:
            $ref: '#/definitions/pbProcessInvitationResponse'
        default:
          description: An unexpected error response.
          schema:
            $ref: '#/definitions/googlerpcStatus'
      parameters:
        - name: body
          ...
          required: true
          schema:
            $ref: '#/definitions/pbProcessInvitationRequest'
      tags:
        - IntraBrokerService
  /intra/table/create:
    post:
      summary: Create a Table you owned in specified Project
      operationId: IntraBrokerService_CreateTable
      responses:
        "200":
          description: A successful response.
          schema:
            $ref: '#/definitions/pbCreateTableResponse'
        default:
          description: An unexpected error response.
          schema:
            $ref: '#/definitions/googlerpcStatus'
  ...
  /intra/table/list:
    post:
      summary: List all Tables in specified Project
      operationId: IntraBrokerService_ListTables
      responses:
        "200":
          description: A successful response.
          schema:
            $ref: '#/definitions/pbListTablesResponse'
        default:
          description: An unexpected error response.
          schema:
            $ref: '#/definitions/googlerpcStatus'
      parameters:
        - name: body
          ...
          required: true
          schema:
            $ref: '#/definitions/pbListTablesRequest'
      tags:
        - IntraBrokerService
  /intra/table/drop:
    post:
      ...
      responses:
        "200":
          description: A successful response.
          schema:
            $ref: '#/definitions/pbDropTableResponse'
        default:
          description: An unexpected error response.
          schema:
            $ref: '#/definitions/googlerpcStatus'
      parameters:
        - name: body
          ...
          required: true
          schema:
            $ref: '#/definitions/pbDropTableRequest'
      tags:
        - IntraBrokerService
  /intra/ccl/grant:
    post:
      summary: Grant CCLs of your Table to a specific member
      operationId: IntraBrokerService_GrantCCL
      responses:
        "200":
          description: A successful response.
          schema:
            $ref: '#/definitions/pbGrantCCLResponse'
        default:
          description: An unexpected error response.
          schema:
            $ref: '#/definitions/googlerpcStatus'
      parameters:
        - name: body
          ...
          required: true
          schema:
            $ref: '#/definitions/pbGrantCCLRequest'
      tags:
        - IntraBrokerService
  /intra/ccl/revoke:
    post:
      summary: Revoke the CCLs you have granted to the specified member
      operationId: IntraBrokerService_RevokeCCL
      responses:
        "200":
          description: A successful response.
          schema:
            $ref: '#/definitions/pbRevokeCCLResponse'
        default:
          description: An unexpected error response.
          schema:
            $ref: '#/definitions/googlerpcStatus'
      parameters:
        - name: body
          ...
          required: true
          schema:
            $ref: '#/definitions/pbRevokeCCLRequest'
      tags:
        - IntraBrokerService
  /intra/ccl/show:
    post:
      summary: Show CCLs in specified Project, supports specifying Tables, members
      operationId: IntraBrokerService_ShowCCL
      responses:
        "200":
          description: A successful response.
          schema:
            $ref: '#/definitions/pbShowCCLResponse'
        default:
          description: An unexpected error response.
          schema:
            $ref: '#/definitions/googlerpcStatus'
      parameters:
        - name: body
          ...
          required: true
          schema:
            $ref: '#/definitions/pbShowCCLRequest'
      tags:
        - IntraBrokerService
definitions:
  ChangeEntryAction:
  ...
  pbCreateTableRequest:
    ...
    properties:
      ...
      columns:
        ...
        items:
          type: object
          $ref: '#/definitions/CreateTableRequestColumnDesc'
  ...
  pbGrantCCLRequest:
    ...
    properties:
      ...
      column_control_list:
        ...
        items:
          type: object
          $ref: '#/definitions/pbColumnControl'
        title: CCLs
    required:
      - project_id
      - column_control_list
  ...
  pbInviteMemberRequest:
    ...
    properties:
      ...
      postscript:
        type: string
      method:
        $ref: '#/definitions/InviteMemberRequestInvitationMethod'
    required:
      - project_id
      - invitee
    ...
    properties:
      invitation_id:
        ...
        title: |-
          ...
          ListInvitation
      respond:
        $ref: '#/definitions/pbInvitationRespond'
  ...
  pbProjectInvitation:
    ...
    properties:
      ...
      postscript:
        type: string
      status:
        $ref: '#/definitions/pbInvitationStatus'
  pbQueryRequest:
    type: object
    example:
      project_id: proj_id
  ...
  pbTableMeta:
    ...
    properties:
      ...
      columns:
        ...
        items:
          type: object
          $ref: '#/definitions/TableMetaColumn'
  pbTensor:
    type: object
    properties:
      name:
