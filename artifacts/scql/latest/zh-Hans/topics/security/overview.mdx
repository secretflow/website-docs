---
git_download_url: https://github.com/secretflow/scql/raw/8f90675e4a85e1c76c0ac9a5720891911bc358d8/docs/topics/security/overview.rst
git_last_modified_commit: 50d1b64da8262e4731766f3ea179d2b0baf82af3
git_last_modified_time: '2023-11-15T17:16:11+08:00'
git_origin_url: https://github.com/secretflow/scql/blob/8f90675e4a85e1c76c0ac9a5720891911bc358d8/docs/topics/security/overview.rst
...
1. SCQL 支持 HTTPS 协议，建议默认开启。有关如何为 SCDB 和 SCQLEngine 启用 HTTPS 的方法详见 [SCDB TLS 配置](../../reference/engine-config.mdx#scdb-tls) and [SCQLEngine TLS 配置](../../reference/engine-config.mdx#scqlengine-tls)。
