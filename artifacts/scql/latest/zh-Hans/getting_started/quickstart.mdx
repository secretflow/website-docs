...
<Container type="note">
  register.sh 脚本会用随机的字符串替代 [examples/docker-compose/client/users.json](https://github.com/secretflow/scql/tree/main/examples/docker-compose/client/users.json) 中的 `__ALICE_TOKEN__` 以及 [examples/docker-compose/scdb/conf/toy\_grm.json](https://github.com/secretflow/scql/tree/main/examples/docker-compose/scdb/conf/toy_grm.json) 中的 `__BOB_TOKEN__`
</Container>
