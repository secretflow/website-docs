---
git_download_url: https://github.com/secretflow/scql/raw/8f90675e4a85e1c76c0ac9a5720891911bc358d8/docs/topics/deployment/how-to-deploy-p2p-cluster.rst
git_last_modified_commit: 8f90675e4a85e1c76c0ac9a5720891911bc358d8
git_last_modified_time: '2023-11-17T17:19:11+08:00'
git_origin_url: https://github.com/secretflow/scql/blob/8f90675e4a85e1c76c0ac9a5720891911bc358d8/docs/topics/deployment/how-to-deploy-p2p-cluster.rst
...
:target{#deployment-in-p2p-mode}

# Deployment in P2P Mode

This document describes how to deploy a SCQL system with docker in P2P mode and use brokerctl to query. It is basically the same as the [P2P Quickstart Tutorial](../../intro/p2p-tutorial.mdx), but deployed on multi machines.
...
See [SCQLBroker configuration options](../../reference/engine-config.mdx#config-broker-server-options) for more.
...
Then you need to replace `__XXX_PUBLIC_KEY__` in party\_info.json and authorized\_profile.json with corresponding public keys.
...
You can start to use brokerctl to submit requests to SCQLBroker and fetch the results back. it’s similar to what you can do in [P2P Quickstart Tutorial](../../intro/p2p-tutorial.mdx).
