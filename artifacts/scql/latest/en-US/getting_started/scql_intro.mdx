...
- Support common SQL select syntax and functions to meet the needs of most scenarios. Please check [SCQL Implementation Status](../reference/scql_status.mdx) for details.
...
- GRM is the abbreviation of [Global Resource Manager](../reference/grm.mdx#grm), which manages the information of the participants and the shared table schemas.
...
- <DefinitionList>
    <dl>
      <dt>
        <DefinitionList.Term><span><code>bank\_1</code></span></DefinitionList.Term>
      </dt>

      <dd>
        Party Bank1 owns the table <code>bank\_1</code> in its local database <code>DB1</code>, which has two columns <code>customer\_id</code> and <code>deposit</code>.
      </dd>
    </dl>
  </DefinitionList>
- <DefinitionList>
    <dl>
      <dt>
        <DefinitionList.Term><span><code>bank\_2</code></span></DefinitionList.Term>
      </dt>

      <dd>
        Party Bank2 owns the table <code>bank\_2</code> in its local database <code>DB2</code>, which has two columns <code>customer\_id</code> and <code>loan</code>.
      </dd>
    </dl>
  </DefinitionList>

<Container type="note">
  The table metadata, such as the table owner and table schema, needs to be registered in GRM, so that SCDB could retrieve the table schema and resolve the table reference. For example, SCDB would resolve <code>table\_1</code> into <code>DB1.bank\_1</code> in party Bank1.
</Container>
...
CCL Form: <code>\<src\_column, dest\_party, constraint></code>
...
- <DefinitionList>
    <dl>
      ...
      <dd>
        - <code>\<bank\_1.customer\_id, Bank1, PLAINTEXT></code>
        - <code>\<bank\_1.deposit, Bank1, PLAINTEXT></code>
        - <code>\<bank\_1.customer\_id, Bank2, PLAINTEXT\_AFTER\_JOIN></code>
        - <code>\<bank\_1.deposit, Bank2, PLAINTEXT\_AFTER\_AGGREGATE></code>
      </dd>
    </dl>
  </DefinitionList>
- <DefinitionList>
    <dl>
      ...
      <dd>
        - <code>\<bank\_2.customer\_id, Bank2, PLAINTEXT></code>
        - <code>\<bank\_2.loan, Bank2, PLAINTEXT></code>
        - <code>\<bank\_2.customer\_id, Bank1, PLAINTEXT\_AFTER\_JOIN></code>
        - <code>\<bank\_2.loan, Bank1, PLAINTEXT\_AFTER\_AGGREGATE></code>
      </dd>
    </dl>
  </DefinitionList>

<Container type="note">
  To learn more about CCL, please read the doc [<span>SCQL CCL</span>](../reference/scql_ccl_intro.mdx).
</Container>
...
:target{#step3-1-build-and-check-ccl}
