...
You could start SCQL service via [docker-compose](https://github.com/secretflow/scql/tree/main/examples/docker-compose), it would deploy and start services as shown in the following figure, it contains a SCDBServer and two SCQLEngines from party `alice`, `bob`.
