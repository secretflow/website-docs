...
1. SCQL supports HTTPS protocol, it is recommended to enable HTTPS by default. Please see [SCDB TLS Configuration](../development/scql_config_manual.mdx#scdb-tls) and [SCQLEngine TLS Configuration](../development/scql_config_manual.mdx#scqlengine-tls) for details on how to enable HTTPS for SCDBServer and SCQLEngine.
