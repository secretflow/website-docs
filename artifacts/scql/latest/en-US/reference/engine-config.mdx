---
git_download_url: https://github.com/secretflow/scql/raw/313796a288c55b3dde2392b0bb9052313dada0b8/docs/reference/engine-config.rst
git_last_modified_commit: 8f90675e4a85e1c76c0ac9a5720891911bc358d8
git_last_modified_time: '2023-11-17T17:19:11+08:00'
git_origin_url: https://github.com/secretflow/scql/blob/313796a288c55b3dde2392b0bb9052313dada0b8/docs/reference/engine-config.rst
...
## <Target id="scdb-config-options" />SCDB configuration options
...
Additionally, it is necessary to configure the SCQLEngine to work with SSL, please refer [Config for SSL in SCQLEngine](#scqlengine-tls).
...
## <Target id="config-broker-server-options" />SCQLBroker configuration options
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        The URLs for local available SCQLEngines
      </td>
    </tr>
...
For more about SecurityCompromise, see [Config for SecurityCompromise](#config-security-compromise-options)

For more about Storage, see [Config for storage](#config-storage-options)

:target{#scqlengine-configuration-options}

## <Target id="engine-config-options" />SCQLEngine configuration options
...
If you want to enable SSL in SCQLEngine, add FLAGS as follows. Additionally, it may be necessary to configure SCDB work with TLS please refer [Config for TLS in SCDB](#scdb-tls).
