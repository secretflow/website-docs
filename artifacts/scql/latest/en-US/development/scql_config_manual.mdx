...
<code>password\_check</code> serves to validate password strength. For ALTER USER, CREATE USER statements, if it’s true, the password should be at least 16 characters which including a number, a lowercase letter, a uppercase letter and a special character.
