---
git_download_url: https://github.com/secretflow/kuscia/raw/afbd52621c2c14c0a838a0ebc4954ee1689be56a/docs/tutorial/run_secretflow_with_api_cn.md
git_last_modified_commit: f1d2ebf6f9a4acd68047fa40b5d06b4140206db7
git_last_modified_time: '2023-12-11T11:09:06+08:00'
git_origin_url: https://github.com/secretflow/kuscia/blob/afbd52621c2c14c0a838a0ebc4954ee1689be56a/docs/tutorial/run_secretflow_with_api_cn.md
...
证书的配置参考[配置授权](../deployment/deploy_p2p_cn.mdx#id3)
...
我们请求[创建 Job](../reference/apis/kusciajob_cn.mdx#createjobrequest) 接口来创建并运行这个 KusciaJob。
...
具体字段数据格式和含义请参考[创建 Job](../reference/apis/kusciajob_cn.mdx#createjobrequest) ，本文不再赘述。
...
我们请求[批量查询 Job 状态](../reference/apis/kusciajob_cn.mdx#batch-query-job-status)接口来批量查询 KusciaJob
的状态。
...
和[批量查询 Job 状态](../reference/apis/kusciajob_cn.mdx#batch-query-job-status)

:target{#id7}

## 删除 KusciaJob

当你想清理这个 KusciaJob 时，我们请求[删除 Job](../reference/apis/kusciajob_cn.mdx#delete-job) 接口来删除这个
KusciaJob.
