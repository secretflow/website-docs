---
git_download_url: https://github.com/secretflow/kuscia/raw/afbd52621c2c14c0a838a0ebc4954ee1689be56a/docs/tutorial/run_fate_cn.md
git_last_modified_commit: 2803dae4ddc014f97b84d6f2f7df76a213eef274
git_last_modified_time: '2023-09-06T16:46:54+08:00'
git_origin_url: https://github.com/secretflow/kuscia/blob/afbd52621c2c14c0a838a0ebc4954ee1689be56a/docs/tutorial/run_fate_cn.md
...
KusciaJob 描述了一个 Pipeline，其中一个 <strong>KusciaTask 对应一个 op 算子</strong>。当然你也可以让一个 KusciaTask 去执行整条 Pipeline，其取决于 `taskInputConfig` 中的定义。
