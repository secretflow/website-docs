...
接下来你可以像 [查看 Kuscia 示例数据](../tutorial/run_secretflow_with_api_cn.mdx#kuscia) 一样查看你的数据文件，这里不再赘述。
...
<Container type="tip">
  ...
  本教程使用的是 SecretFlow 的算子参数定义。关于该定义的更多细节，敬请查阅 [SecretFlow 的对应文档](https://www.secretflow.org.cn/docs/secretflow/latest/zh-Hans/component)。
</Container>
