---
git_download_url: https://github.com/secretflow/kuscia/raw/afbd52621c2c14c0a838a0ebc4954ee1689be56a/docs/deployment/operation_cn.md
git_last_modified_commit: 081e9466177fa4bbc8620744824c51c681e047e7
git_last_modified_time: '2023-10-13T10:57:05+08:00'
git_origin_url: https://github.com/secretflow/kuscia/blob/afbd52621c2c14c0a838a0ebc4954ee1689be56a/docs/deployment/operation_cn.md
...
- \{container\_name} 是你要进入的容器的 NAME。
...
- \{src\_file} 是源文件的路径。
- \{container\_name} 是目标容器的 NAME。
- \{dst\_path\_or\_file\_on\_container} 是目标容器的路径或目标文件名。
...
的更多信息，请查看 [Domain](../reference/concepts/domain_cn.mdx) 。
...
- \{domain\_name} 为要查看的 DomainRoute 所在的 Domain 的名称。
- \{domain\_router\_name} 为要查看的 DomainRoute 的名称。
...
有关 DomainRoute 的更多信息，请查看 [DomainRoute](../reference/concepts/domainroute_cn.mdx) 。
...
有关 AppImage 的更多信息，请查看 [AppImage](../reference/concepts/appimage_cn.mdx) 。

:target{#kusciajob-kusciatask}

### KusciaJob & KusciaTask

关于如何配置、运行和查看 KusciaJob 和 KusciaTask，请参考 [如何运行一个 SecretFlow 作业](../getting_started/run_secretflow_cn.mdx) 和 [KusciaJob](../reference/concepts/kusciajob_cn.mdx) 。
...
- \{container\_id-name}为要进入任务容器的 ID。
