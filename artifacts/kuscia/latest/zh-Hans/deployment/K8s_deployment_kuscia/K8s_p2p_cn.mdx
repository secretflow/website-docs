---
git_download_url: https://github.com/secretflow/kuscia/raw/cdf8fea273ddec092fa9b4f22fc3ded837ad3dcd/docs/deployment/K8s_deployment_kuscia/K8s_p2p_cn.md
git_last_modified_commit: b1c00628b40f7699f7bebc423d2f0e755d5413b0
git_last_modified_time: '2023-12-25T16:32:09+08:00'
git_origin_url: https://github.com/secretflow/kuscia/blob/cdf8fea273ddec092fa9b4f22fc3ded837ad3dcd/docs/deployment/K8s_deployment_kuscia/K8s_p2p_cn.md
...
本教程帮助你在 k8s 集群上使用 [点对点组网模式](../../reference/architecture_cn.mdx#peer-to-peer) 来部署 Kuscia 集群。目前 kuscia 在部署到 k8s 上时，隐私计算任务的运行态仅支持 runk 模式，runp 模式正在开发中，详细参考[容器运行模式](../../reference/architecture_cn.mdx#agent)；runc 模式目前需要部署 kuscia 的 pod 有特权容器，暂时不是特别推荐，所以下文默认的模式以 runk 模式来进行部署（需要能够有权限在宿主的 K8s 上拉起任务 pod）。
