---
git_download_url: https://github.com/secretflow/kuscia/raw/4ded8d874369b27490181937494abb301d249f7c/docs/reference/troubleshoot/kuscia_vs_ray.md
git_last_modified_commit: b1c00628b40f7699f7bebc423d2f0e755d5413b0
git_last_modified_time: '2023-12-25T16:32:09+08:00'
git_origin_url: https://github.com/secretflow/kuscia/blob/4ded8d874369b27490181937494abb301d249f7c/docs/reference/troubleshoot/kuscia_vs_ray.md
...
Kuscia 和 Ray 通常被误认为只能二选一，其实 Kuscia 与 Ray 所在的分层不同，彼此不同但相互补充。如下图所示，Ray 位于引擎层作为 SecretFlow 底层的函数级调度框架。Kuscia 位于框架层致力于解决隐私计算生产落地过程中的共性问题[详见 Kuscia 概述文档](../overview.mdx)。
![Kuscia\_Layer](../../_assets/kuscia_layer.png)

:target{#secretflow-ray}
...
![secretflow\_developer\_view](../../_assets/sf_dev_view.png)
下面给出以各自视角和以上帝视角编程的伪代码示例，让大家可以直观感受到两者编程的差异：

<table style={{"borderCollapse":"collapse","width":"100%"}}>
  <tbody>
    <tr>
      <th colSpan="2" style={{"border":"1px solid black"}}>{"各自视角"}</th><th style={{"border":"1px solid black"}}>{"上帝视角"}</th>
    </tr>
...
当然 Kuscia 的能力远不止如此，更多信息请参考 [Kuscia 概述文档](../overview.mdx)。
