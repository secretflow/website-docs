...
<table>
  ...
  <tbody>
    <tr>
      <td>
        [<span>CreateDomainData</span>](#create-domain-data)
      </td>
    ...
    <tr>
      <td>
        [<span>UpdateDomainData</span>](#update-domain-data)
      </td>
    ...
    <tr>
      <td>
        [<span>DeleteDomainData</span>](#delete-domain-data)
      </td>
    ...
    <tr>
      <td>
        [<span>QueryDomainData</span>](#query-domain-data)
      </td>
    ...
    <tr>
      <td>
        [<span>BatchQueryDomainData</span>](#batch-query-domain-data)
      </td>
    ...
    <tr>
      <td>
        [<span>ListDomainData</span>](#list-domain-data)
      </td>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        [<span>DataColumn</span>](#data-column) array
      </td>
    ...
    <tr>
      ...
      <td>
        来源，用于查询接口筛选数据对象，参考 [<span>ListDomainDataRequestData</span>](#list-domain-data-request-data) 和 [<span>DomainData概念</span>](../concepts/domaindata_cn.mdx)
      </td>
    </tr>
  </tbody>
</table>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        [<span>DataColumn</span>](#data-column)\[]
      </td>
    ...
    <tr>
      ...
      <td>
        来源，用于批量查询接口筛选数据对象，参考 [<span>ListDomainDataRequestData</span>](#list-domain-data-request-data) 和 [<span>DomainData概念</span>](../concepts/domaindata_cn.mdx)
      </td>
    </tr>
  </tbody>
</table>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        [<span>QueryDomainDataRequestData</span>](#query-domain-data-request-data)
      </td>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        [<span>DomainData</span>](#domain-data-entity)
      </td>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        [<span>DomainDataList</span>](#domain-data-list)
      </td>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        [<span>ListDomainDataRequestData</span>](#list-domain-data-request-data)
      </td>
