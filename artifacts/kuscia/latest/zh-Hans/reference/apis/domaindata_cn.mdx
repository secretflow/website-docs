---
git_download_url: https://github.com/secretflow/kuscia/raw/afbd52621c2c14c0a838a0ebc4954ee1689be56a/docs/reference/apis/domaindata_cn.md
git_last_modified_commit: 312299cba3241f8b44a899e1d8bf40a1d2a9bbcc
git_last_modified_time: '2023-11-08T21:07:54+08:00'
git_origin_url: https://github.com/secretflow/kuscia/blob/afbd52621c2c14c0a838a0ebc4954ee1689be56a/docs/reference/apis/domaindata_cn.md
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        数据对象 ID，满足 [DNS 子域名规则要求](https://kubernetes.io/zh-cn/docs/concepts/overview/working-with-objects/names/#dns-subdomain-names)
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        相对数据源所在位置的路径，参考 [<span>DomainData 概念</span>](../concepts/domaindata_cn.mdx)
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        数据源 ID，不填写则使用默认数据源，参考 [<span>DomainData 概念</span>](../concepts/domaindata_cn.mdx)
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        自定义属性，用作用户或应用算法组件为数据对象添加扩展信息，参考 [<span>DomainData 概念</span>](../concepts/domaindata_cn.mdx)
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        来源，用于查询接口筛选数据对象，参考 [ListDomainDataRequestData](#list-domain-data-request-data) 和 [<span>DomainData 概念</span>](../concepts/domaindata_cn.mdx)
      </td>
    </tr>
  </tbody>
</table>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        来源，用于批量查询接口筛选数据对象，参考 [ListDomainDataRequestData](#list-domain-data-request-data) 和 [<span>DomainData 概念</span>](../concepts/domaindata_cn.mdx)
      </td>
    </tr>
  </tbody>
</table>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        数据源 ID，参考 [<span>DomainData 概念</span>](../concepts/domaindata_cn.mdx)
      </td>
    </tr>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        类型，当前版本由应用算法组件定义和消费，参考 [<span>DomainData 概念</span>](../concepts/domaindata_cn.mdx)
      </td>
    </tr>
