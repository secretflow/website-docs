---
git_download_url: https://github.com/secretflow/kuscia/raw/afbd52621c2c14c0a838a0ebc4954ee1689be56a/docs/reference/apis/summary_cn.md
git_last_modified_commit: afbd52621c2c14c0a838a0ebc4954ee1689be56a
git_last_modified_time: '2023-12-12T11:52:31+08:00'
git_origin_url: https://github.com/secretflow/kuscia/blob/afbd52621c2c14c0a838a0ebc4954ee1689be56a/docs/reference/apis/summary_cn.md
...
K8s API 是基于 K8s 接口，以 CRD 的形式提供，请参考 [概念](../concepts/index.mdx) 。
...
如 [CreateDomainDataRequest](domaindata_cn.mdx#create-domain-data-request) ， 该字段可以携带你自定义的一些数据。

响应总是携带一个 status 字段，类型为 [Status](#status) ，
如 [CreateDomainDataResponse](domaindata_cn.mdx#create-domain-data-response) ， 该字段描述了响应的状态信息。
