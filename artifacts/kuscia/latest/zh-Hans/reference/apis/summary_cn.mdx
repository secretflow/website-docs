...
的 [JSON Mapping](https://protobuf.dev/programming-guides/proto3/#json) 。当请求的 <code>Content-Type</code> 为 <code>application/x-protobuf</code> 时，使用 PROTOBUF 编码，否则使用 JSON 编码。
