---
git_download_url: https://github.com/secretflow/kuscia/raw/afbd52621c2c14c0a838a0ebc4954ee1689be56a/docs/reference/concepts/kusciadeployment_cn.md
git_last_modified_commit: bdea9a1f97178c4b34dacfdf4a95b49d0951f899
git_last_modified_time: '2023-12-06T13:36:22+08:00'
git_origin_url: https://github.com/secretflow/kuscia/blob/afbd52621c2c14c0a838a0ebc4954ee1689be56a/docs/reference/concepts/kusciadeployment_cn.md
...
- `parties`：表示所有参与方的信息。
  - `parties[].appImageRef`：表示参与方所依赖的应用镜像名称。有关 AppImage 的详细介绍，请参考 [AppImage](appimage_cn.mdx)。
  ...
  - `parties[].template`：表示参与方应用的模版信息。若配置了该模版，则使用该模版中配置的信息替换从`parties[].appImageRef`获取的对应模版信息。
    ...
    - `template.spec`：表示应用容器配置信息。所支持的子字段请参考 AppImage 描述中的 [deployTemplates\[\].spec](appimage_cn.mdx#appimage-ref)
...
:target{#sf-serving-appimage}

### Serving AppImage

下面是名称为`secretflow-serving-image`的 AppImage 定义。有关 AppImage 的详细介绍，请参考 [AppImage](appimage_cn.mdx)。
