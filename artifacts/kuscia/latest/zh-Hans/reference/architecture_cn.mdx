---
git_download_url: https://github.com/secretflow/kuscia/raw/4ded8d874369b27490181937494abb301d249f7c/docs/reference/architecture_cn.md
git_last_modified_commit: 96591ccd92e300dcd4d5f1302f149ebd4b41277b
git_last_modified_time: '2024-01-08T15:19:31+08:00'
git_origin_url: https://github.com/secretflow/kuscia/blob/4ded8d874369b27490181937494abb301d249f7c/docs/reference/architecture_cn.md
...
![Kuscia Architecture](../_assets/kuscia_architecture.png)

Kuscia 支持 Lite 节点与 Autonomy 节点、以及两个中心化网络互联互通，并支持与第三方产商的节点互联互通，从而构建更大的隐私计算网络。

![Deployment Mode](../_assets/linkaged_network.png)
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        申请机构 K8s 动态创建资源权限（例如 Pod、ConfigMap 等）
      </td>
    </tr>
...
![Centralized Network Mode](../_assets/centralized_network_mode.png)
...
![Decentralized Network Mode](../_assets/p2p_network_mode.png)
...
- <strong>Docker 模式</strong>：适合基于物理机或虚拟机部署隐私计算任务的机构，可以直接在机器上以 Docker 容器方式部署控制平面和节点实例。
- <strong>K8s 模式</strong>：适合基于公有 K8s 集群部署隐私计算任务的机构，可将控制平面和节点以 K8s 应用的方式部署到机构 K8s 集群中。
- <strong>K8s 控制器模式</strong>：适合基于专有 K8s 集群部署隐私计算任务的机构，可将 Kuscia Controllers、Kuscia Storage、Envoy 部署在 K8s 集群的控制平面中。

![Deployment Mode](../_assets/deployment_mode.png)
...
![Deployment Mode](../_assets/job_schedule.png)
