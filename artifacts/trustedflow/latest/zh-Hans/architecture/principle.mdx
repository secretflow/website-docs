---
git_download_url: https://github.com/secretflow/trustedflow/raw/e529736dda5000fa638150b0c1992a603de524ba/docs/architecture/principle.md
git_last_modified_commit: bfe84b20af212b670353e9be8664d40d35b6a345
git_last_modified_time: '2023-11-09T20:01:51+08:00'
git_origin_url: https://github.com/secretflow/trustedflow/blob/e529736dda5000fa638150b0c1992a603de524ba/docs/architecture/principle.md
...
3. 数据持有方根据数据使用需求，生成授权策略，详见[授权策略](../quick_start/step3.mdx)，策略文件使用持有方的私钥进行签名。
...
![principle.png](../_assets/trustedflow_principle.png)
