...
git_download_url: https://github.com/secretflow/trustedflow/raw/e529736dda5000fa638150b0c1992a603de524ba/docs/architecture/apps/binary_evaluation.md
git_origin_url: https://github.com/secretflow/trustedflow/blob/e529736dda5000fa638150b0c1992a603de524ba/docs/architecture/apps/binary_evaluation.md
...
3. 输出：结果为一个report，包含以下内容：
   (1) summary\_report: 总结报告，包含total\_samples、positive\_samples、negative\_samples、auc、ks和f1\_score。
   (2) eq\_frequent\_bin\_report: 等频分箱报告。
   (3) eq\_range\_bin\_report: 等距分箱报告。
   (4) head\_report: FPR=\[0.001，0.005，0.01，0.05，0.1，0.2]的精度报告，包含fpr、precision、recall和threshold。
