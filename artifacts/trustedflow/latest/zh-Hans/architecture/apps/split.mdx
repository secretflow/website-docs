...
git_download_url: https://github.com/secretflow/trustedflow/raw/e529736dda5000fa638150b0c1992a603de524ba/docs/architecture/apps/split.md
git_origin_url: https://github.com/secretflow/trustedflow/blob/e529736dda5000fa638150b0c1992a603de524ba/docs/architecture/apps/split.md
...
1. 参数
   (1) train\_size: 训练集占的比例，取值范围为(0, 1)，默认值为0.75。
   (2) fix\_random: 是否使用固定的随机数种子。
   (3) random\_state: 随机数种子，取值为integer，默认值为1024。
