...
- the op takes two parameters, first type is <code>type(V0, D0)</code>, second type is <code>type(V1, D1)</code>.
- the op returns <code>type(narrow(V0, V1), promote(D0, D1))</code> as a result.
