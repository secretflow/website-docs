---
git_download_url: https://github.com/secretflow/spu/raw/0883c15512c9e4d3e4ec7bbe27e038fd084a2eee/docs/tutorials/cpp_lr_example.rst
git_last_modified_commit: 62283664bc7d558687424e235ca6d84aaa82c29f
git_last_modified_time: '2023-10-13T04:30:51-05:00'
git_origin_url: https://github.com/secretflow/spu/blob/0883c15512c9e4d3e4ec7bbe27e038fd084a2eee/docs/tutorials/cpp_lr_example.rst
...
:target{#c-example-logistic-regression}

# C++ Example: Logistic Regression

To use SPU C++ API, we have to first [From Source](../getting_started/install.mdx#from-source), this document shows how to write a privacy preserving logistic regression program with SPU C++ API.
