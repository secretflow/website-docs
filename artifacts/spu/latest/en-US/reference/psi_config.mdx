...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        [<span> InputParams</span>](#inputparams)
      </td>
    ...
    <tr>
      ...
      <td>
        [<span> OutputParams</span>](#outputparams)
      </td>
    ...
    <tr>
      ...
      <td>
        [<span> DpPsiParams</span>](#dppsiparams)
      </td>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        The count of intersection. Get <code>-1</code> when self party can not get result.
      </td>
    </tr>
  </tbody>
</table>
