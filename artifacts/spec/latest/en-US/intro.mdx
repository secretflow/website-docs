...
We introduce [DistData](spec.mdx#id3) to represent inputs and outputs in privacy-preserving applications.
...
### [DataRef](spec.mdx#distdata-dataref)
...
#### [Atomic Attributes](spec.mdx#attributedef-atomicattrdesc)

For <strong>Atomic Attributes</strong>, first you should indicate with “type” field in [AttributeDef](spec.mdx#id13).
...
- AT\_STRING
- AT\_BOOL
  And corresponding scalar list types. You may check [AttrType](spec.mdx#id18) as well.
...
To define a Struct Attribute Group, you should indicate with “type” field in [AttributeDef](spec.mdx#id13) with AT\_STRUCT\_GROUP.
...
To define a Union Attribute Group, you should indicate with “type” field in [AttributeDef](spec.mdx#id13) with AT\_UNION\_GROUP. Afterwards, you should use [UnionAttrGroupDesc](spec.mdx#attributedef-unionattrgroupdesc) to specify the default selection of children.
...
IoDef is to specify the requirement of an input or output of the component. You should use <strong>types</strong> to declare accepted types of [DistData](spec.mdx#id3).
...
[Attribute](spec.mdx#id12) is used to express the value of an attribute. Please use <em>is\_na</em> to indicate the value is <em>n/a</em> explicitly.
...
- If you choose children named e, the attr is a [Attribute](spec.mdx#id12) with <em>s</em> field is e, i.e. children selection is a string.
- If you choose children named f, the attr is a [Attribute](spec.mdx#id12) with <em>s</em> field is f.
...
You should use <em>ss</em> field of [Attribute](spec.mdx#id12) to list selected columns.
